...
| Third-country transfer outside adequacy decision | **No** | All U.S. recipients (GitHub, OpenAI, Azure OpenAI, Anthropic, Slack) are DPF-certified; Standard Contractual Clauses Module 2 under Art. 46(2)(c) GDPR are contracted as a fall-back. |
