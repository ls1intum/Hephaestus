...
- **Send feedback**, under **Sending feedback**, controls whether newly admitted feedback may leave the
  ...
  terminally withheld; resuming applies only to work reviewed afterwards and never flushes old work.

All three are prospective, and the price is worth knowing before you touch them: changing coverage,
**Send feedback**, **Post feedback after merge**, or the workspace default autonomy discards whatever was
already reviewed and not yet sent — narrowing as much as widening. Changing the cooldown does not, and
