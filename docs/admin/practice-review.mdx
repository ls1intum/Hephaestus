...
2. Open **Administration → AI models** and assign a ready model to **Practice reviews**.
3. Open **Administration → Practices → Review**. Under **When and where**, turn on
   **Start practice reviews** and **Automatic reviews**.
4. Under **How much**, choose **Propose** for a delivery-free trial or **Deliver** to allow feedback to
   reach its eligible lanes. Leave repository and target-branch scope empty for the first test.
