...
4. Under **Autonomy**, choose **Review before sending** for the first test. Keep coverage at **All
   monitored repositories** and **All eligible linked members**.
...
- **Delivery active/paused** controls whether newly admitted feedback may leave the review pipeline. Pausing
  does not stop measurement and does not discard configuration. Paused feedback is terminally withheld;
  resuming applies only to work admitted under the new rollout revision and never flushes old work.
