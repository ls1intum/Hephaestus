...
job or workspace; selected coverage targets follow their workspace membership or monitored repository.
...
therefore stalls in `UNCERTAIN` rather than risking a duplicate.
