...
2. **Configure Keycloak:**
   ...
   - Confirm the GitHub identity provider requests the `user:email read:org` scopes and disable username/password login flows to keep authentication SSO-only.
