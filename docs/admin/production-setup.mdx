...
| `LEGAL_PROFILE` | Selects a bundled imprint/privacy profile. Use `tum` only for the canonical AET deployment; self-hosters leave empty and mount `/legal-overrides/`. See [Legal Pages](./legal-pages). |
