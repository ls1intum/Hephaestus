...
| `HEPHAESTUS_EVIDENCE_AUTHORIZED_SOURCE_KINDS` | Comma-separated deployment allowlist of source kinds. Empty by default; use `*` only after the controller has approved every source in the selected contract. |
