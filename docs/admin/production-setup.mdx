...
- A workspace admin can instead connect its own provider ("bring your own AI provider") under the workspace's AI settings; that workspace's usage is priced and capped independently of the instance catalog.
