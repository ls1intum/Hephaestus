...
| Variable | Purpose |
| --- | --- |
| `WEBHOOK_SECRET` | HMAC secret for GitHub and GitLab webhooks (`openssl rand -base64 32`) |
...
**Webhook secret:** Set `WEBHOOK_SECRET` to the secret configured on your GitHub and GitLab webhooks (generate with `openssl rand -base64 32`).
