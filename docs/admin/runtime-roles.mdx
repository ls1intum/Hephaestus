...
- [ADR 0005](../decisions/0005-two-role-runtime-via-conditional-on-property.md) — original two-role design.
- [ADR 0008](../decisions/0008-webhook-runtime-role.md) — webhook role rationale.
- [ADR 0009](../decisions/0009-worker-runtime-substrate-wss-control-channel.md) — worker substrate + WSS.
