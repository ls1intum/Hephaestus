...
| Area | Why it matters |
| --- | --- |
| **Dashboard** | Home base with your weekly objectives, guidance reminders, and quick access to the AI mentor or leaderboard. |
...
1. **Trigger your first mentor session.** Navigate to **Mentor → Start session** and pick the *Retrospective* template. Heph will walk you through goal setting, PR highlights, and next steps.
