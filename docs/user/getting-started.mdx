...
- **Outline**, when your workspace mirrors a team wiki, lets the reviewer read the design docs and decision records your work links to. Connect your Outline account under **Settings → Connected accounts** so the documents you wrote are recognised as yours. Linking is optional, and Outline can never be used to sign in to Hephaestus.
