...
description: Discover how Hephaestus detects practice patterns and guides every contributor toward growth.
---

**How You Build Matters.** Hephaestus observes how participants collaborate — from issues to pull requests to code reviews — detects the practices that drive quality, and guides every contributor — human and AI — toward growth. Whether you're onboarding into your first project or leading reviews across multiple repositories, Hephaestus adapts its support to where you are.
