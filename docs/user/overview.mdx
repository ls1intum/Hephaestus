...
description: Discover what Hephaestus offers end users and how the platform blends AI mentoring with practice reflection.
---

**Process-Aware Mentoring for Agile Software Teams.** Onboard faster and learn better habits with an AI mentor grounded in your repo workflow – covering issues, commits, pull requests, and team rituals. Hephaestus combines AI-guided reflection and actionable practice insights so new contributors build good habits quickly while experienced reviewers stay engaged.
...
- **My Practices** reflection cards on your workspace home, tied to your review cycle, with no ranking or score.
- **Achievements** that recognize consistent contributions and healthy habits.
- **Activity Monitor** that gives you a transparent, append-only log of your contributions.
...
- Researchers evaluating review activity, mentoring engagement, or practice-reflection outcomes.
...
3. Open the **Mentor** tab to set your goals, then reflect on **My Practices** on your workspace home.
