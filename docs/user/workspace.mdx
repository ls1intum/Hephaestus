...
Hephaestus keeps you on the same kind of page when it applies to both workspaces. From a page for a specific person, conversation, practice, or other workspace item, switching opens the workspace home page instead. A page option that names something in the workspace you are leaving, such as a team filter, is cleared; options that mean the same in any workspace, such as sorting and the time range, carry over. If you open a link to a workspace that is no longer available to you, Hephaestus opens the home page of another workspace you can access, or tells you that you are not in a workspace yet. Signing in opens the first workspace you can access.
