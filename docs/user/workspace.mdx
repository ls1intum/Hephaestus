...
All search parameters reset when you switch.
If the workspace in a saved link is no longer available to you, Hephaestus opens the home page of
another workspace you can access, or the no-workspace page when none remain.
