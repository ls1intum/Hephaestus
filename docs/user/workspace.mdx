...
Hephaestus keeps you on the same kind of page when it applies to both workspaces. From a page for a
specific person, conversation, practice, or other workspace item, switching opens the workspace home
page instead. Filters and other page options in the URL reset when you switch.
If you open a link to a workspace that is no longer available to you, Hephaestus opens the home
page of another workspace you can access, or tells you that you are not in a workspace yet.
Signing in opens the first workspace you can access, not the one you were in last.
