...
description: How Hephaestus reviews your pull and merge requests and issues, and gives practice-based feedback.
---

Hephaestus automatically reviews your work on GitHub and GitLab and gives you feedback on software engineering practices. When you open a non-draft pull or merge request, the system analyzes your changes and posts comments highlighting what you did well and where you can improve. Issues you author can receive practice feedback as well.
...
### Documentation the reviewer can read

If your workspace connects a team wiki ([Outline](https://www.getoutline.com/)), the reviewer can read the
documents your work points at. Link an architecture decision record or design doc from the MR description or
an issue and the reviewer reads that document rather than guessing at it, so feedback on practices like
*"records significant decisions with rationale"* is grounded in what you actually wrote.

Only the collections an administrator chose to mirror are ever read, the reviewer never writes anything back
to the wiki, and a document that is deleted upstream is dropped from Hephaestus too. Connecting your own
Outline account under **Settings → Connected accounts** lets the documents you authored be attributed to you.
