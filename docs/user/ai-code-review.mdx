...
On a **GitLab merge request**, after you push new commits, start a comment with:
...
There is no equivalent command on GitHub pull requests; reviews there start from the events the
workspace's practices are bound to.
