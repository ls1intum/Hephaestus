...
:::info
The preference suppresses comment delivery only. The review still runs and observations are stored for the workspace's Practice Overview, visible to administrators and owners.
:::
