...
## Stop receiving comments

Open **Settings → Practice feedback** and turn off **Pull request comments** to stop Hephaestus from posting new practice-feedback comments on your pull requests or merge requests.

This setting controls delivery only. Reviews can still run, and their findings are still stored and may be visible to workspace admins. It does not delete earlier comments or findings.
