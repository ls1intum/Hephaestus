...
Sign in with your GitHub account. When your workspace has the leaderboard enabled, it is the home page; select the Hephaestus logo in the top-left corner to return to it.
