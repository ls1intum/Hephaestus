...
- `spring-boot-starter-liquibase` — `LiquibaseAutoConfiguration` moved out of `spring-boot-autoconfigure` into `spring-boot-liquibase` in Boot 4; without this dep, Liquibase is silently inert at runtime.
