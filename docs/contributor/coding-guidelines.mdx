...
- Respect React Compiler requirements. No conditional hooks. No prop mutation. Because the compiler memoises for you, hand-written `useMemo`, `useCallback` and `React.memo` are banned in new code.
