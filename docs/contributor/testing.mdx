...
2. Run the appropriate command:
   ...
   success while test sources fail to compile. Pass `-P'!quick'` on every test run.
   :::
...
./mvnw test -P'!quick' -Dtest=UserServiceTest # Single test class
./mvnw test -P'!quick' -Dtest=UserServiceTest#methodName # Single test method
```
