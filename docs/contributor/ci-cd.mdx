...
| Application Server   | `server/**`, `scripts/**` (includes webhook receiver — ADR 0008), `docker/agents/**`, `tsconfig.agents.json` |
...
pnpm run typecheck:agents      # Precompute TypeScript
```
