...
| Scheduled image rescans | weekly | findings update an issue; scanner failure fails the run | `main` images: the drift tracking issue; released images: the vulnerability response issue |
