...
| **Observation** | One measurement — one practice's answer about one piece of work, immutable, kept forever. Carries `reasoning` and never advice. | finding, verdict, result |
...
| **Move** | What is composed for the mentor conversation: an opener, the evidence, and the target. Not a script — the mentor writes the turn's words. | conversation message, prepared reply, script |
