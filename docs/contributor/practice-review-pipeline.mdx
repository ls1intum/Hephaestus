...
| Units per run | at most 3                                                                 | at most 2                                | at most 3                                                                                        |
...
the same practice; history alone cannot become a public claim. The per-lane caps above restate caps the
lanes themselves own; `FeedbackCompositionCapsTest` is what stops the two copies drifting.
...
conversation. The mentor may adapt, defer, or discard a prepared note when it no longer fits the live turn.
