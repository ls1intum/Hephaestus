...
- **Intelligence Service** - TypeScript + Hono mentor logic that produces conversational guidance and artifacts.
- **Webhook Ingest** - NATS-based ingestion for GitHub/GitLab events, decoupling external webhooks from downstream processing.
