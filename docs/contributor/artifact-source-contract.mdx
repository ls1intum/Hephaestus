...
Workspace-level gates decide whether a review is admitted at all, before any source is captured. They
...
- **Review coverage.** Repository and linked-person coverage are intersected. Selected-empty, an unlinked
  author, or a repository/base branch outside the selection is refused before evidence capture.

These controls are defined in the [practice review glossary](./practice-review-glossary.mdx). They are not
evidence concerns—they decide whether evidence is collected at all.
