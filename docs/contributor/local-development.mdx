...
The intelligence service is a Node.js/TypeScript application using Hono and AI SDK v6. For details, see the dedicated [Intelligence Service guide](/contributor/intelligence-service).
