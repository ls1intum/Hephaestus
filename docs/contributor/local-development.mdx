...
The intelligence service is now a Node.js/TypeScript application using Hono and AI SDK v6. For detailed documentation including AI observability setup with Langfuse, see the dedicated [Intelligence Service guide](/contributor/intelligence-service).
