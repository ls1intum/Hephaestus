...
```
/workspace/
├── repo/                  # Bind-mounted git working tree — READ-ONLY. The real cloned repo.
├── context/
│   ├── target/            # System-written, AI-readable. Populated by ContentProvider SPI.
│   │                      # Files: metadata.json, comments.json, diff.patch, diff_stat.txt,
│   │                      # diff_summary.md, contributor_history.json
