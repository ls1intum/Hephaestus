...
Hephaestus is maintained by the Applied Education Technologies (AET) team at TUM. It evaluates contributions against team-defined practices and provides AI coaching grounded in actual project activity. Practices are organized across four dimensions: technical, process, social, and cognitive.

This guide covers everything you need to develop, test, and ship changes to Hephaestus.
