...
The pages here explain the system and human workflow; when they disagree with executable configuration,
generated API output, or tests, fix the prose in the same pull request.
