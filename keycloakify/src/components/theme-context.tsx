...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  const [currentTheme, setCurrentTheme] = useState<AppTheme | undefined>(getInitialTheme());
  ...
  const updateMetaThemeColor = () => {
    if (metaThemeColor) {
      const backgroundColor = getComputedStyle(htmlElement).getPropertyValue('--background').trim();
  ...
  return (
    <ThemeContext.Provider value={{ currentTheme, setLightTheme, setDarkTheme, setSystemTheme }}>
      {children}
