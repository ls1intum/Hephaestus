...
export const listWorkspaces1ResponseTransformer = async (data: any): Promise<ListWorkspaces1Response> => {
...
export const createWorkspace1ResponseTransformer = async (data: any): Promise<CreateWorkspace1Response> => {
