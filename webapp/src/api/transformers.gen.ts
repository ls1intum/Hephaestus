...
import type { ListWorkspacesResponse, CreateWorkspaceResponse, GetWorkspaceResponse, GetActivityByUserResponse, VoteMessageResponse, GetUserDocumentsResponse, CreateDocumentResponse, GetDocumentResponse, UpdateDocumentResponse, DeleteVersionsAfterTimestampResponse, GetDocumentVersionsResponse, GetDocumentVersionResponse, GetLeaderboardResponse, ListMembersResponse, AssignRoleResponse, GetCurrentUserMembershipResponse, GetMemberResponse, GetThreadResponse, GetThreadsResponse, GetGroupedThreadsResponse, GetWorkspaceMetaResponse, UpdateNotificationsResponse, UpdatePublicVisibilityResponse, UpdateScheduleResponse, UpdateSlackCredentialsResponse, UpdateStatusResponse, GetAllTeamsResponse, RemoveLabelFromTeamResponse, AddLabelToTeamResponse, UpdateTokenResponse, GetUserProfileResponse } from './types.gen';
...
export const getWorkspaceMetaResponseTransformer = async (data: any): Promise<GetWorkspaceMetaResponse> => {
