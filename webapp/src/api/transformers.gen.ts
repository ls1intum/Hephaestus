...
import type { ListWorkspacesResponse, CreateWorkspaceResponse, GetWorkspaceResponse, GetActivityByUserResponse, GetLeaderboardResponse, ListMembersResponse, AssignRoleResponse, GetCurrentUserMembershipResponse, GetMemberResponse, VoteMessageResponse, GetDocumentsResponse, CreateDocumentResponse, GetDocumentResponse, UpdateDocumentResponse, GetDocumentVersionsResponse, GetDocumentVersionResponse, GetGroupedThreadsResponse, UpdateNotificationsResponse, GetUserProfileResponse, UpdatePublicVisibilityResponse, UpdateScheduleResponse, UpdateSlackCredentialsResponse, RenameSlugResponse, UpdateStatusResponse, GetAllTeamsResponse, RemoveLabelFromTeamResponse, AddLabelToTeamResponse, UpdateTokenResponse } from './types.gen';
...
export const getDocumentsResponseTransformer = async (data: any): Promise<GetDocumentsResponse> => {
    data = data.map((item: any) => {
