...
export type Achievement = {
     ...
     */
    id: 'pr.merged.common.1' | 'pr.merged.common.2' | 'pr.merged.uncommon' | 'pr.merged.rare' | 'pr.merged.epic' | 'pr.merged.legendary' | 'pr.special.speedster' | 'review.common.1' | 'review.common.2' | 'review.uncommon.1' | 'review.uncommon.2' | 'review.rare' | 'review.epic' | 'review.legendary' | 'review.mythic' | 'issue.open.common.1' | 'issue.open.common.2' | 'issue.open.uncommon' | 'issue.open.rare' | 'issue.open.epic' | 'issue.open.legendary' | 'issue.close.common.1' | 'issue.close.common.2' | 'issue.close.uncommon' | 'issue.close.rare' | 'issue.close.epic' | 'issue.close.legendary' | 'milestone.first_action' | 'milestone.polyglot' | 'milestone.night_owl' | 'milestone.long_time_return' | 'milestone.all_rare' | 'milestone.all_epic' | 'milestone.all_legendary';
    /**
     * Parent achievement in progression chain
     */
    parent?: 'pr.merged.common.1' | 'pr.merged.common.2' | 'pr.merged.uncommon' | 'pr.merged.rare' | 'pr.merged.epic' | 'pr.merged.legendary' | 'pr.special.speedster' | 'review.common.1' | 'review.common.2' | 'review.uncommon.1' | 'review.uncommon.2' | 'review.rare' | 'review.epic' | 'review.legendary' | 'review.mythic' | 'issue.open.common.1' | 'issue.open.common.2' | 'issue.open.uncommon' | 'issue.open.rare' | 'issue.open.epic' | 'issue.open.legendary' | 'issue.close.common.1' | 'issue.close.common.2' | 'issue.close.uncommon' | 'issue.close.rare' | 'issue.close.epic' | 'issue.close.legendary' | 'milestone.first_action' | 'milestone.polyglot' | 'milestone.night_owl' | 'milestone.long_time_return' | 'milestone.all_rare' | 'milestone.all_epic' | 'milestone.all_legendary';
    /**
