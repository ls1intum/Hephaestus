...
export type ReviewBoundFeedback = {
     ...
     */
    suppressionReason?: 'VOLUME_CAPPED' | 'COMPOSER_DEDUPED' | 'REACTED_DISPUTED' | 'REACTED_NOT_APPLICABLE' | 'CONVERSATION_EXPIRED' | 'ARTIFACT_GONE' | 'ARTIFACT_CLOSED' | 'ARTIFACT_MERGED' | 'ARTIFACT_DRAFT' | 'RECIPIENT_OPTED_OUT' | 'EMPTY_AFTER_SANITIZE' | 'INSTANCE_SILENCED' | 'WORKSPACE_DISABLED' | 'APPROVAL_STALE' | 'PRACTICE_REQUIRES_APPROVAL' | 'BACKFILL_QUIET';
};
...
export type PracticeReviewSettings = {
    ...
    defaultAutonomy: 'OFF' | 'HUMAN_APPROVAL' | 'AUTOMATIC';
    /**
     * Raw override; null = this workspace has never chosen, so AUTOMATIC applies
     */
