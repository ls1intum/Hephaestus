...
import { addLabelToTeam, addRepositoryToMonitor, createDocument, deleteDocument, deleteUser, deleteVersionsAfterTimestamp, detectBadPracticesByUser, detectBadPracticesForPullRequest, getActivityByUser, getAllTeams, getContributors, getDocument, getDocumentVersion, getDocumentVersions, getGroupedThreads, getLeaderboard, getMetaData, getRepositoriesToMonitor, getThread, getThreads, getUserDocuments, getUserLeagueStats, getUserProfile, getUserSettings, getUsersWithTeams, type Options, provideFeedbackForBadPractice, removeLabelFromTeam, removeRepositoryToMonitor, resetAndRecalculateLeagues, resolveBadPractice, updateDocument, updateTeamVisibility, updateUserSettings, voteMessage } from '../sdk.gen';
import type { AddLabelToTeamData, AddLabelToTeamResponse, AddRepositoryToMonitorData, CreateDocumentData, CreateDocumentError, CreateDocumentResponse, DeleteDocumentData, DeleteDocumentResponse, DeleteUserData, DeleteVersionsAfterTimestampData, DeleteVersionsAfterTimestampError, DeleteVersionsAfterTimestampResponse, DetectBadPracticesByUserData, DetectBadPracticesForPullRequestData, GetActivityByUserData, GetAllTeamsData, GetContributorsData, GetDocumentData, GetDocumentVersionData, GetDocumentVersionsData, GetDocumentVersionsError, GetDocumentVersionsResponse, GetGroupedThreadsData, GetLeaderboardData, GetLeaderboardResponse, GetMetaDataData, GetRepositoriesToMonitorData, GetThreadData, GetThreadsData, GetUserDocumentsData, GetUserDocumentsResponse, GetUserLeagueStatsData, GetUserLeagueStatsResponse, GetUserProfileData, GetUserSettingsData, GetUsersWithTeamsData, ProvideFeedbackForBadPracticeData, RemoveLabelFromTeamData, RemoveLabelFromTeamResponse, RemoveRepositoryToMonitorData, ResetAndRecalculateLeaguesData, ResolveBadPracticeData, UpdateDocumentData, UpdateDocumentError, UpdateDocumentResponse, UpdateTeamVisibilityData, UpdateUserSettingsData, UpdateUserSettingsResponse, VoteMessageData, VoteMessageError, VoteMessageResponse } from '../types.gen';
