...
import { type Options, listGlobalContributors, deleteUser, getUserSettings, updateUserSettings, getUserProfile, listWorkspaces1, createWorkspace1, listWorkspaces, createWorkspace, listMembers, assignRole, removeMember, getMember, purgeWorkspace, getWorkspace, provideFeedbackForBadPractice, resolveBadPractice, detectBadPracticesForPullRequest, detectBadPracticesByUser, getActivityByUser, voteMessage, getUserDocuments, createDocument, deleteDocument, getDocument, updateDocument, deleteVersionsAfterTimestamp, getDocumentVersions, getDocumentVersion, getLeaderboard, getUserLeagueStats, resetAndRecalculateLeagues, getThread, getThreads, getGroupedThreads, getWorkspaceMeta, listWorkspaceContributors, updateNotifications, updatePublicVisibility, getRepositoriesToMonitor, removeRepositoryToMonitor, addRepositoryToMonitor, updateSchedule, updateSlackCredentials, updateStatus, getAllTeams, updateTeamVisibility, updateRepositoryVisibility, removeLabelFromTeam, addLabelToTeam, updateToken, getUsersWithTeams } from '../sdk.gen';
...
export const listWorkspaces1QueryKey = (options?: Options<ListWorkspaces1Data>) => createQueryKey('listWorkspaces1', options);

/**
 * List all workspaces
 */
export const listWorkspaces1Options = (options?: Options<ListWorkspaces1Data>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listWorkspaces1({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listWorkspaces1QueryKey(options)
    });
};

export const createWorkspace1QueryKey = (options: Options<CreateWorkspace1Data>) => createQueryKey('createWorkspace1', options);

/**
 * Create a new workspace
 */
export const createWorkspace1Options = (options: Options<CreateWorkspace1Data>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createWorkspace1({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createWorkspace1QueryKey(options)
    });
};
 ...
 * Create a new workspace
 */
export const createWorkspace1Mutation = (options?: Partial<Options<CreateWorkspace1Data>>): UseMutationOptions<CreateWorkspace1Response, DefaultError, Options<CreateWorkspace1Data>> => {
    const mutationOptions: UseMutationOptions<CreateWorkspace1Response, DefaultError, Options<CreateWorkspace1Data>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createWorkspace1({
                ...options,
                ...localOptions,
...
export const getWorkspaceMetaOptions = (options: Options<GetWorkspaceMetaData>) => {
    return queryOptions({
        ...
        queryKey: getWorkspaceMetaQueryKey(options)
    });
};
