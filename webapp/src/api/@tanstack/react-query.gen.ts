...
export const adminGetInstanceSettingsQueryKey = (options?: Options<AdminGetInstanceSettingsData>) => createQueryKey('adminGetInstanceSettings', options);
 ...
 */
export const adminUpdateSilentModeMutation = (options?: Partial<Options<AdminUpdateSilentModeData>>): UseMutationOptions<AdminUpdateSilentModeResponse, DefaultError, Options<AdminUpdateSilentModeData>> => {
    const mutationOptions: UseMutationOptions<AdminUpdateSilentModeResponse, DefaultError, Options<AdminUpdateSilentModeData>> = {
        mutationFn: async (fnOptions) => {
