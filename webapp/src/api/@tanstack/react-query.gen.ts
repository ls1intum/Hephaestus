 ...
 */
export const triggerSyncJobMutation = (options?: Partial<Options<TriggerSyncJobData>>): UseMutationOptions<TriggerSyncJobResponse, DefaultError, Options<TriggerSyncJobData>> => {
    const mutationOptions: UseMutationOptions<TriggerSyncJobResponse, DefaultError, Options<TriggerSyncJobData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const cancelConnectionSyncJobMutation = (options?: Partial<Options<CancelConnectionSyncJobData>>): UseMutationOptions<CancelConnectionSyncJobResponse, DefaultError, Options<CancelConnectionSyncJobData>> => {
    const mutationOptions: UseMutationOptions<CancelConnectionSyncJobResponse, DefaultError, Options<CancelConnectionSyncJobData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await cancelConnectionSyncJob({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
