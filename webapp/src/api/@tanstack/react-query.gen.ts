...
import { type Options, listGlobalContributors, deleteUser, getUserSettings, updateUserSettings, listWorkspaces, createWorkspace, purgeWorkspace, getWorkspace, getLeaderboard, computeUserLeagueStats, resetAndRecalculateLeagues, listMembers, assignRole, getCurrentUserMembership, removeMember, getMember, listDocuments, createDocument, deleteDocument, getDocument, updateDocument, deleteDocumentVersionsAfter, listVersions, getVersion, voteMessage, getGroupedThreads, getThread, updateNotifications, getBadPractice, provideFeedback, resolve, getBadPracticesForPullRequest, detectForPullRequest, getBadPracticesForUser, detectForUser, getUserProfile, updatePublicVisibility, getRepositoriesToMonitor, removeRepositoryToMonitor, addRepositoryToMonitor, updateSchedule, updateSlackCredentials, renameSlug, updateStatus, getAllTeams, updateTeamVisibility, updateRepositoryVisibility, removeLabelFromTeam, addLabelToTeam, getTeamSettings, updateTeamSettings, getLabelFilters, removeLabelFilter, addLabelFilter, getRepositorySettings, updateRepositorySettings, updateToken, getUsersWithTeams } from '../sdk.gen';
 ...
 */
export const computeUserLeagueStatsOptions = (options: Options<ComputeUserLeagueStatsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
