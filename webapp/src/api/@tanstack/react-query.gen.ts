...
export const getPracticeAreaStandingsQueryKey = (options: Options<GetPracticeAreaStandingsData>) => createQueryKey('getPracticeAreaStandings', options, false, ['Practice Areas']);
 ...
 */
export const getPracticeAreaStandingsOptions = (options: Options<GetPracticeAreaStandingsData>) => queryOptions<GetPracticeAreaStandingsResponse, DefaultError, GetPracticeAreaStandingsResponse, ReturnType<typeof getPracticeAreaStandingsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPracticeAreaStandings({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPracticeAreaStandingsQueryKey(options)
});
 ...
 */
export const getFeedbackResponseOptions = (options: Options<GetFeedbackResponseData>) => queryOptions<GetFeedbackResponseResponse, GetFeedbackResponseError, GetFeedbackResponseResponse, ReturnType<typeof getFeedbackResponseQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
