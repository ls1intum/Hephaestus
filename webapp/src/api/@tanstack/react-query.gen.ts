...
export const listPracticeAreaStandingsQueryKey = (options: Options<ListPracticeAreaStandingsData>) => createQueryKey('listPracticeAreaStandings', options, false, ['Practice Area Standings']);
 ...
 */
export const listPracticeAreaStandingsOptions = (options: Options<ListPracticeAreaStandingsData>) => queryOptions<ListPracticeAreaStandingsResponse, DefaultError, ListPracticeAreaStandingsResponse, ReturnType<typeof listPracticeAreaStandingsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listPracticeAreaStandings({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listPracticeAreaStandingsQueryKey(options)
});
...
export const listPracticeAreaReviewRunsQueryKey = (options: Options<ListPracticeAreaReviewRunsData>) => createQueryKey('listPracticeAreaReviewRuns', options, false, ['Practice Area Detail']);
 ...
 */
export const listPracticeAreaReviewRunsOptions = (options: Options<ListPracticeAreaReviewRunsData>) => queryOptions<ListPracticeAreaReviewRunsResponse, ListPracticeAreaReviewRunsError, ListPracticeAreaReviewRunsResponse, ReturnType<typeof listPracticeAreaReviewRunsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listPracticeAreaReviewRuns({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listPracticeAreaReviewRunsQueryKey(options)
});

export const listPracticeAreaReviewRunsInfiniteQueryKey = (options: Options<ListPracticeAreaReviewRunsData>): QueryKey<Options<ListPracticeAreaReviewRunsData>> => createQueryKey('listPracticeAreaReviewRuns', options, true);
 ...
 * Returns complete review runs newest first. Each review run contains the concrete positive and negative observations that explain what the review observed.
 */
export const listPracticeAreaReviewRunsInfiniteOptions = (options: Options<ListPracticeAreaReviewRunsData>) => infiniteQueryOptions<ListPracticeAreaReviewRunsResponse, ListPracticeAreaReviewRunsError, InfiniteData<ListPracticeAreaReviewRunsResponse>, QueryKey<Options<ListPracticeAreaReviewRunsData>>, number | Pick<QueryKey<Options<ListPracticeAreaReviewRunsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<ListPracticeAreaReviewRunsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
    ...
    queryKey: listPracticeAreaReviewRunsInfiniteQueryKey(options)
});

export const getPracticeAreaTrendQueryKey = (options: Options<GetPracticeAreaTrendData>) => createQueryKey('getPracticeAreaTrend', options, false, ['Practice Area Detail']);
 ...
 */
export const getPracticeAreaTrendOptions = (options: Options<GetPracticeAreaTrendData>) => queryOptions<GetPracticeAreaTrendResponse, DefaultError, GetPracticeAreaTrendResponse, ReturnType<typeof getPracticeAreaTrendQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPracticeAreaTrend({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPracticeAreaTrendQueryKey(options)
});
