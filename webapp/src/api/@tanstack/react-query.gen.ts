 ...
 */
export const removeFeedbackRatingMutation = (options?: Partial<Options<RemoveFeedbackRatingData>>): UseMutationOptions<RemoveFeedbackRatingResponse, DefaultError, Options<RemoveFeedbackRatingData>> => {
    const mutationOptions: UseMutationOptions<RemoveFeedbackRatingResponse, DefaultError, Options<RemoveFeedbackRatingData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await removeFeedbackRating({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const setFeedbackRatingMutation = (options?: Partial<Options<SetFeedbackRatingData>>): UseMutationOptions<SetFeedbackRatingResponse, DefaultError, Options<SetFeedbackRatingData>> => {
    const mutationOptions: UseMutationOptions<SetFeedbackRatingResponse, DefaultError, Options<SetFeedbackRatingData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setFeedbackRating({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
