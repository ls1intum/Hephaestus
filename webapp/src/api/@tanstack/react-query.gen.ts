...
import { type Options, provideFeedbackForBadPractice, resolveBadPractice, detectBadPracticesForPullRequest, detectBadPracticesByUser, getActivityByUser, voteMessage, getUserDocuments, createDocument, deleteDocument, getDocument, updateDocument, deleteVersionsAfterTimestamp, getDocumentVersions, getDocumentVersion, getLeaderboard, getUserLeagueStats, getThread, getThreads, getGroupedThreads, getMetaData, getContributors, getAllTeams, updateTeamVisibility, deleteUser, getUserSettings, updateUserSettings, getUserProfile, resetAndRecalculateLeagues, getRepositoriesToMonitor, removeRepositoryToMonitor, addRepositoryToMonitor, removeLabelFromTeam, addLabelToTeam, getUsersWithTeams } from '../sdk.gen';
