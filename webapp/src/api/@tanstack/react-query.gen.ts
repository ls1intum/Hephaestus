...
export const getPendingQueryKey = (options?: Options<GetPendingData>) => createQueryKey('getPending', options);

/**
 * List pending dead letters
 * Returns all pending dead letters, ordered by creation time (oldest first)
 */
export const getPendingOptions = (options?: Options<GetPendingData>) => {
    return queryOptions({
        ...
        queryKey: getPendingQueryKey(options)
    });
};
...
export const discardQueryKey = (options: Options<DiscardData>) => createQueryKey('discard', options);

/**
 * Discard a dead letter
 * Marks a dead letter as discarded (will not be retried)
 */
export const discardOptions = (options: Options<DiscardData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: discardQueryKey(options)
    });
};
 ...
 * Marks a dead letter as discarded (will not be retried)
 */
export const discardMutation = (options?: Partial<Options<DiscardData>>): UseMutationOptions<unknown, DefaultError, Options<DiscardData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DiscardData>> = {
...
export const retryQueryKey = (options: Options<RetryData>) => createQueryKey('retry', options);

/**
 * Retry a dead letter
 * Attempts to re-record the failed activity event
 */
export const retryOptions = (options: Options<RetryData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: retryQueryKey(options)
    });
};
 ...
 * Attempts to re-record the failed activity event
 */
export const retryMutation = (options?: Partial<Options<RetryData>>): UseMutationOptions<RetryResponse, RetryError, Options<RetryData>> => {
    const mutationOptions: UseMutationOptions<RetryResponse, RetryError, Options<RetryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await retry({
                ...options,
                ...localOptions,
