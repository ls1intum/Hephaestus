...
export const resetLeagueMutation = (options?: Partial<Options<ResetLeagueData>>): UseMutationOptions<ResetLeagueResponse, DefaultError, Options<ResetLeagueData>> => {
    const mutationOptions: UseMutationOptions<ResetLeagueResponse, DefaultError, Options<ResetLeagueData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await resetLeague({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const removeRepositoryMutation = (options?: Partial<Options<RemoveRepositoryData>>): UseMutationOptions<RemoveRepositoryResponse, DefaultError, Options<RemoveRepositoryData>> => {
    const mutationOptions: UseMutationOptions<RemoveRepositoryResponse, DefaultError, Options<RemoveRepositoryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await removeRepository({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const addRepositoryQueryKey = (options: Options<AddRepositoryData>) => createQueryKey('addRepository', options);

export const addRepositoryOptions = (options: Options<AddRepositoryData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: addRepositoryQueryKey(options)
    });
};

export const addRepositoryMutation = (options?: Partial<Options<AddRepositoryData>>): UseMutationOptions<AddRepositoryResponse, DefaultError, Options<AddRepositoryData>> => {
    const mutationOptions: UseMutationOptions<AddRepositoryResponse, DefaultError, Options<AddRepositoryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addRepository({
                ...options,
                ...localOptions,
