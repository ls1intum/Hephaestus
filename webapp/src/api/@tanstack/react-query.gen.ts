 ...
 */
export const unlinkIdentityMutation = (options?: Partial<Options<UnlinkIdentityData>>): UseMutationOptions<unknown, DefaultError, Options<UnlinkIdentityData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<UnlinkIdentityData>> = {
        mutationFn: async (fnOptions) => {
