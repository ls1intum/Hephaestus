 ...
 */
export const adminGetPracticeEvidenceOptionsOptions = (options?: Options<AdminGetPracticeEvidenceOptionsData>) => queryOptions<AdminGetPracticeEvidenceOptionsResponse, DefaultError, AdminGetPracticeEvidenceOptionsResponse, ReturnType<typeof adminGetPracticeEvidenceOptionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await adminGetPracticeEvidenceOptions({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: adminGetPracticeEvidenceOptionsQueryKey(options)
});
 ...
 * Returns recommended requirements and allowed evidence sources for each type of reviewed work
 */
export const getPracticeEvidenceOptionsOptions = (options: Options<GetPracticeEvidenceOptionsData>) => queryOptions<GetPracticeEvidenceOptionsResponse, DefaultError, GetPracticeEvidenceOptionsResponse, ReturnType<typeof getPracticeEvidenceOptionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPracticeEvidenceOptions({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPracticeEvidenceOptionsQueryKey(options)
});
 ...
 */
export const setUsedInNewReviewsMutation = (options?: Partial<Options<SetUsedInNewReviewsData>>): UseMutationOptions<SetUsedInNewReviewsResponse, SetUsedInNewReviewsError, Options<SetUsedInNewReviewsData>> => {
    const mutationOptions: UseMutationOptions<SetUsedInNewReviewsResponse, SetUsedInNewReviewsError, Options<SetUsedInNewReviewsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setUsedInNewReviews({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
