...
export const listPracticeAreaReviewHistoryQueryKey = (options: Options<ListPracticeAreaReviewHistoryData>) => createQueryKey('listPracticeAreaReviewHistory', options, false, ['Practice Area Detail']);
...
export const listPracticeAreaReviewHistoryOptions = (options: Options<ListPracticeAreaReviewHistoryData>) => queryOptions<ListPracticeAreaReviewHistoryResponse, ListPracticeAreaReviewHistoryError, ListPracticeAreaReviewHistoryResponse, ReturnType<typeof listPracticeAreaReviewHistoryQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listPracticeAreaReviewHistory({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listPracticeAreaReviewHistoryQueryKey(options)
});

export const listPracticeAreaReviewHistoryInfiniteQueryKey = (options: Options<ListPracticeAreaReviewHistoryData>): QueryKey<Options<ListPracticeAreaReviewHistoryData>> => createQueryKey('listPracticeAreaReviewHistory', options, true);
...
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<ListPracticeAreaReviewHistoryData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
    ...
    queryKey: listPracticeAreaReviewHistoryInfiniteQueryKey(options)
});

export const listPracticeAreaTrendQueryKey = (options: Options<ListPracticeAreaTrendData>) => createQueryKey('listPracticeAreaTrend', options, false, ['Practice Area Detail']);
 ...
 */
export const listPracticeAreaTrendOptions = (options: Options<ListPracticeAreaTrendData>) => queryOptions<ListPracticeAreaTrendResponse, DefaultError, ListPracticeAreaTrendResponse, ReturnType<typeof listPracticeAreaTrendQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listPracticeAreaTrend({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listPracticeAreaTrendQueryKey(options)
});
...
export const getFeedbackEngagementQueryKey = (options: Options<GetFeedbackEngagementData>) => createQueryKey('getFeedbackEngagement', options, false, ['Feedback Response']);

/**
 * Get feedback resolution counts
 */
export const getFeedbackEngagementOptions = (options: Options<GetFeedbackEngagementData>) => queryOptions<GetFeedbackEngagementResponse, DefaultError, GetFeedbackEngagementResponse, ReturnType<typeof getFeedbackEngagementQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getFeedbackEngagement({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getFeedbackEngagementQueryKey(options)
});
...
export const getLatestFeedbackResponseQueryKey = (options: Options<GetLatestFeedbackResponseData>) => createQueryKey('getLatestFeedbackResponse', options, false, ['Feedback Response']);

/**
 * Get the latest feedback response
 */
export const getLatestFeedbackResponseOptions = (options: Options<GetLatestFeedbackResponseData>) => queryOptions<GetLatestFeedbackResponseResponse, GetLatestFeedbackResponseError, GetLatestFeedbackResponseResponse, ReturnType<typeof getLatestFeedbackResponseQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getLatestFeedbackResponse({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getLatestFeedbackResponseQueryKey(options)
});
 ...
 */
export const submitFeedbackResponseMutation = (options?: Partial<Options<SubmitFeedbackResponseData>>): UseMutationOptions<SubmitFeedbackResponseResponse, SubmitFeedbackResponseError, Options<SubmitFeedbackResponseData>> => {
    const mutationOptions: UseMutationOptions<SubmitFeedbackResponseResponse, SubmitFeedbackResponseError, Options<SubmitFeedbackResponseData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await submitFeedbackResponse({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
