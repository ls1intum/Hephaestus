 ...
 */
export const removeFeedbackHelpfulnessRatingMutation = (options?: Partial<Options<RemoveFeedbackHelpfulnessRatingData>>): UseMutationOptions<RemoveFeedbackHelpfulnessRatingResponse, DefaultError, Options<RemoveFeedbackHelpfulnessRatingData>> => {
    const mutationOptions: UseMutationOptions<RemoveFeedbackHelpfulnessRatingResponse, DefaultError, Options<RemoveFeedbackHelpfulnessRatingData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await removeFeedbackHelpfulnessRating({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const rateFeedbackHelpfulnessMutation = (options?: Partial<Options<RateFeedbackHelpfulnessData>>): UseMutationOptions<RateFeedbackHelpfulnessResponse, DefaultError, Options<RateFeedbackHelpfulnessData>> => {
    const mutationOptions: UseMutationOptions<RateFeedbackHelpfulnessResponse, DefaultError, Options<RateFeedbackHelpfulnessData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await rateFeedbackHelpfulness({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
