...
export const getPracticeAreaStatusesQueryKey = (options: Options<GetPracticeAreaStatusesData>) => createQueryKey('getPracticeAreaStatuses', options, false, ['Practice Areas']);
...
export const getPracticeAreaStatusesOptions = (options: Options<GetPracticeAreaStatusesData>) => queryOptions<GetPracticeAreaStatusesResponse, DefaultError, GetPracticeAreaStatusesResponse, ReturnType<typeof getPracticeAreaStatusesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPracticeAreaStatuses({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPracticeAreaStatusesQueryKey(options)
});
