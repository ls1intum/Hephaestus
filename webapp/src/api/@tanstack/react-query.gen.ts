...
export const getWorkspaceProvidersQueryKey = (options?: Options<GetWorkspaceProvidersData>) => createQueryKey('getWorkspaceProviders', options);
 ...
 */
export const getWorkspaceProvidersOptions = (options?: Options<GetWorkspaceProvidersData>) => queryOptions<GetWorkspaceProvidersResponse, DefaultError, GetWorkspaceProvidersResponse, ReturnType<typeof getWorkspaceProvidersQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getWorkspaceProviders({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getWorkspaceProvidersQueryKey(options)
});
