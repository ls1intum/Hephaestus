 ...
 */
export const getLatestFeedbackResponseOptions = (options: Options<GetLatestFeedbackResponseData>) => queryOptions<GetLatestFeedbackResponseResponse, DefaultError, GetLatestFeedbackResponseResponse, ReturnType<typeof getLatestFeedbackResponseQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const submitFeedbackResponseMutation = (options?: Partial<Options<SubmitFeedbackResponseData>>): UseMutationOptions<SubmitFeedbackResponseResponse, DefaultError, Options<SubmitFeedbackResponseData>> => {
    const mutationOptions: UseMutationOptions<SubmitFeedbackResponseResponse, DefaultError, Options<SubmitFeedbackResponseData>> = {
        mutationFn: async (fnOptions) => {
