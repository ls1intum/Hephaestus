...
export const chatQueryKey = (options: Options<ChatData>) => createQueryKey('chat', options);
 ...
 * Send a message to the AI mentor and receive a streaming response
 */
export const chatMutation = (options?: Partial<Options<ChatData>>): UseMutationOptions<unknown, DefaultError, Options<ChatData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<ChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await chat({
                ...options,
                ...localOptions,
 ...
 * Upvote or downvote a chat message
 */
export const voteMessageMutation = (options?: Partial<Options<VoteMessageData>>): UseMutationOptions<VoteMessageResponse, DefaultError, Options<VoteMessageData>> => {
    const mutationOptions: UseMutationOptions<VoteMessageResponse, DefaultError, Options<VoteMessageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await voteMessage({
                ...options,
                ...localOptions,
 ...
 */
export const deleteVersionsAfterTimestampMutation = (options?: Partial<Options<DeleteVersionsAfterTimestampData>>): UseMutationOptions<DeleteVersionsAfterTimestampResponse, DefaultError, Options<DeleteVersionsAfterTimestampData>> => {
    const mutationOptions: UseMutationOptions<DeleteVersionsAfterTimestampResponse, DefaultError, Options<DeleteVersionsAfterTimestampData>> = {
        mutationFn: async (localOptions) => {
