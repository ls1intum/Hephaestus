 ...
 */
export const cancelConnectionSyncJobMutation = (options?: Partial<Options<CancelConnectionSyncJobData>>): UseMutationOptions<CancelConnectionSyncJobResponse, CancelConnectionSyncJobError, Options<CancelConnectionSyncJobData>> => {
    const mutationOptions: UseMutationOptions<CancelConnectionSyncJobResponse, CancelConnectionSyncJobError, Options<CancelConnectionSyncJobData>> = {
        mutationFn: async (fnOptions) => {
