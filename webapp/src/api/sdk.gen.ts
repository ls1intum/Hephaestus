 ...
 */
export const getUserLeagueStats = <ThrowOnError extends boolean = false>(options: Options<GetUserLeagueStatsData, ThrowOnError>) => (options.client ?? client).post<GetUserLeagueStatsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const mentorChat = <ThrowOnError extends boolean = false>(options: Options<MentorChatData, ThrowOnError>) => (options.client ?? client).sse.post<MentorChatResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
