...
/**
 * List the current developer's practice area standings
 *
 * Returns every active practice area's standing, direction, guidance, and supporting observations.
 */
export const listPracticeAreaStandings = <ThrowOnError extends boolean = false>(options: Options<ListPracticeAreaStandingsData, ThrowOnError>) => (options.client ?? client).get<ListPracticeAreaStandingsResponses, unknown, ThrowOnError>({
    responseTransformer: listPracticeAreaStandingsResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listPracticeAreaReviewRuns = <ThrowOnError extends boolean = false>(options: Options<ListPracticeAreaReviewRunsData, ThrowOnError>) => (options.client ?? client).get<ListPracticeAreaReviewRunsResponses, ListPracticeAreaReviewRunsErrors, ThrowOnError>({
    responseTransformer: listPracticeAreaReviewRunsResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getPracticeAreaTrend = <ThrowOnError extends boolean = false>(options: Options<GetPracticeAreaTrendData, ThrowOnError>) => (options.client ?? client).get<GetPracticeAreaTrendResponses, GetPracticeAreaTrendErrors, ThrowOnError>({
    responseTransformer: getPracticeAreaTrendResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
