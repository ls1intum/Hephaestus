 ...
 */
export const adminGetPracticeEvidenceOptions = <ThrowOnError extends boolean = false>(options?: Options<AdminGetPracticeEvidenceOptionsData, ThrowOnError>) => (options?.client ?? client).get<AdminGetPracticeEvidenceOptionsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 * Returns workspace practice definitions, optionally filtered by review participation
 */
 ...
 * Returns recommended requirements and allowed evidence sources for each type of reviewed work
 */
export const getPracticeEvidenceOptions = <ThrowOnError extends boolean = false>(options: Options<GetPracticeEvidenceOptionsData, ThrowOnError>) => (options.client ?? client).get<GetPracticeEvidenceOptionsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * List practices used in new reviews, learner-facing
 *
 * Returns the learner-facing name, area, rationale, and example for practices used in new reviews
 */
...
/**
 * Choose whether new reviews include a practice
 */
export const setUsedInNewReviews = <ThrowOnError extends boolean = false>(options: Options<SetUsedInNewReviewsData, ThrowOnError>) => (options.client ?? client).patch<SetUsedInNewReviewsResponses, SetUsedInNewReviewsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
