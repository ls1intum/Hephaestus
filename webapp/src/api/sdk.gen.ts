 ...
 */
export const cancelConnectionSyncJob = <ThrowOnError extends boolean = false>(options: Options<CancelConnectionSyncJobData, ThrowOnError>) => (options.client ?? client).post<CancelConnectionSyncJobResponses, CancelConnectionSyncJobErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
