 ...
 */
export const unlinkIdentity = <ThrowOnError extends boolean = false>(options: Options<UnlinkIdentityData, ThrowOnError>) => (options.client ?? client).delete<UnlinkIdentityResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
