 ...
 */
export const computeUserLeagueStats = <ThrowOnError extends boolean = false>(options: Options<ComputeUserLeagueStatsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ComputeUserLeagueStatsResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
