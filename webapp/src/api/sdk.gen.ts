 ...
 */
export const slackCallback = <ThrowOnError extends boolean = false>(options: Options<SlackCallbackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SlackCallbackResponses, unknown, ThrowOnError>({
 ...
 */
export const disconnectSlack = <ThrowOnError extends boolean = false>(options?: Options<DisconnectSlackData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DisconnectSlackResponses, unknown, ThrowOnError>({
 ...
 */
export const getSlackConnection = <ThrowOnError extends boolean = false>(options?: Options<GetSlackConnectionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetSlackConnectionResponses, unknown, ThrowOnError>({
        url: '/user/slack-connection',
        ...options
    });
};
 ...
 */
export const syncSlackConnection = <ThrowOnError extends boolean = false>(options?: Options<SyncSlackConnectionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SyncSlackConnectionResponses, unknown, ThrowOnError>({
 ...
 */
export const installSlackBot = <ThrowOnError extends boolean = false>(options: Options<InstallSlackBotData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<InstallSlackBotResponses, unknown, ThrowOnError>({
