 ...
 */
export const getFeedbackEngagement = <ThrowOnError extends boolean = false>(options: Options<GetFeedbackEngagementData, ThrowOnError>) => (options.client ?? client).get<GetFeedbackEngagementResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Get the latest feedback response
 */
export const getLatestFeedbackResponse = <ThrowOnError extends boolean = false>(options: Options<GetLatestFeedbackResponseData, ThrowOnError>) => (options.client ?? client).get<GetLatestFeedbackResponseResponses, GetLatestFeedbackResponseErrors, ThrowOnError>({
    responseTransformer: getLatestFeedbackResponseResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
