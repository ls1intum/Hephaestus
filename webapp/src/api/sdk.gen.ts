...
/**
 * Remove a usefulness rating
 */
export const removeFeedbackHelpfulnessRating = <ThrowOnError extends boolean = false>(options: Options<RemoveFeedbackHelpfulnessRatingData, ThrowOnError>) => (options.client ?? client).delete<RemoveFeedbackHelpfulnessRatingResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Rate delivered practice feedback
 */
export const rateFeedbackHelpfulness = <ThrowOnError extends boolean = false>(options: Options<RateFeedbackHelpfulnessData, ThrowOnError>) => (options.client ?? client).post<RateFeedbackHelpfulnessResponses, RateFeedbackHelpfulnessErrors, ThrowOnError>({
    responseTransformer: rateFeedbackHelpfulnessResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/workspaces/{workspaceSlug}/practices/feedback/{feedbackId}/helpfulness',
    ...options,
    headers: {
