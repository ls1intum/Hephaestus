 ...
 */
export const reviewTierRollup = <ThrowOnError extends boolean = false>(options: Options<ReviewTierRollupData, ThrowOnError>) => (options.client ?? client).get<ReviewTierRollupResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
