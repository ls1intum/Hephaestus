...
import type { ProvideFeedbackForBadPracticeData, ProvideFeedbackForBadPracticeResponses, ResolveBadPracticeData, ResolveBadPracticeResponses, DetectBadPracticesForPullRequestData, DetectBadPracticesForPullRequestResponses, DetectBadPracticesByUserData, DetectBadPracticesByUserResponses, GetActivityByUserData, GetActivityByUserResponses, VoteMessageData, VoteMessageResponses, VoteMessageErrors, GetUserDocumentsData, GetUserDocumentsResponses, CreateDocumentData, CreateDocumentResponses, CreateDocumentErrors, DeleteDocumentData, DeleteDocumentResponses, DeleteDocumentErrors, GetDocumentData, GetDocumentResponses, GetDocumentErrors, UpdateDocumentData, UpdateDocumentResponses, UpdateDocumentErrors, DeleteVersionsAfterTimestampData, DeleteVersionsAfterTimestampResponses, DeleteVersionsAfterTimestampErrors, GetDocumentVersionsData, GetDocumentVersionsResponses, GetDocumentVersionsErrors, GetDocumentVersionData, GetDocumentVersionResponses, GetDocumentVersionErrors, GetLeaderboardData, GetLeaderboardResponses, GetUserLeagueStatsData, GetUserLeagueStatsResponses, GetThreadData, GetThreadResponses, GetThreadErrors, GetThreadsData, GetThreadsResponses, GetThreadsErrors, GetGroupedThreadsData, GetGroupedThreadsResponses, GetGroupedThreadsErrors, GetMetaDataData, GetMetaDataResponses, GetContributorsData, GetContributorsResponses, GetAllTeamsData, GetAllTeamsResponses, UpdateTeamVisibilityData, UpdateTeamVisibilityResponses, UpdateRepositoryVisibilityData, UpdateRepositoryVisibilityResponses, DeleteUserData, DeleteUserResponses, GetUserSettingsData, GetUserSettingsResponses, UpdateUserSettingsData, UpdateUserSettingsResponses, GetUserProfileData, GetUserProfileResponses, ListWorkspacesData, ListWorkspacesResponses, CreateWorkspaceData, CreateWorkspaceResponses, PurgeWorkspaceData, PurgeWorkspaceResponses, GetWorkspaceData, GetWorkspaceResponses, ResetLeagueData, ResetLeagueResponses, ListMembersData, ListMembersResponses, AssignRoleData, AssignRoleResponses, RemoveMemberData, RemoveMemberResponses, GetMemberData, GetMemberResponses, UpdateNotificationsData, UpdateNotificationsResponses, UpdatePublicVisibilityData, UpdatePublicVisibilityResponses, GetRepositoriesData, GetRepositoriesResponses, RemoveRepositoryData, RemoveRepositoryResponses, AddRepositoryData, AddRepositoryResponses, ResumeWorkspaceData, ResumeWorkspaceResponses, UpdateScheduleData, UpdateScheduleResponses, UpdateSlackCredentialsData, UpdateSlackCredentialsResponses, SuspendWorkspaceData, SuspendWorkspaceResponses, RemoveLabelFromTeamData, RemoveLabelFromTeamResponses, AddLabelToTeamData, AddLabelToTeamResponses, UpdateTokenData, UpdateTokenResponses, GetUsersData, GetUsersResponses } from './types.gen';
...
export const resetLeague = <ThrowOnError extends boolean = false>(options: Options<ResetLeagueData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<ResetLeagueResponses, unknown, ThrowOnError>({
...
export const updateNotifications = <ThrowOnError extends boolean = false>(options: Options<UpdateNotificationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateNotificationsResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/notifications',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
export const updatePublicVisibility = <ThrowOnError extends boolean = false>(options: Options<UpdatePublicVisibilityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdatePublicVisibilityResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/public-visibility',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
export const removeRepository = <ThrowOnError extends boolean = false>(options: Options<RemoveRepositoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<RemoveRepositoryResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/repositories/{owner}/{name}',
        ...options
    });
};

export const addRepository = <ThrowOnError extends boolean = false>(options: Options<AddRepositoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AddRepositoryResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/repositories/{owner}/{name}',
        ...options
    });
};

export const resumeWorkspace = <ThrowOnError extends boolean = false>(options: Options<ResumeWorkspaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResumeWorkspaceResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/resume',
        ...options
    });
};
...
export const updateSlackCredentials = <ThrowOnError extends boolean = false>(options: Options<UpdateSlackCredentialsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateSlackCredentialsResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/slack-credentials',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
export const suspendWorkspace = <ThrowOnError extends boolean = false>(options: Options<SuspendWorkspaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SuspendWorkspaceResponses, unknown, ThrowOnError>({
        url: '/workspaces/{slug}/suspend',
        ...options
    });
};
