 ...
 */
export const adminUpdateSilentMode = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateSilentModeData, ThrowOnError>) => (options.client ?? client).put<AdminUpdateSilentModeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
