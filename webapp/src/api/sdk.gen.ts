 ...
 * List all workspaces
 */
export const listWorkspaces1 = <ThrowOnError extends boolean = false>(options?: Options<ListWorkspaces1Data, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListWorkspaces1Responses, unknown, ThrowOnError>({
        url: '/workspaces',
        ...options
    });
};
 ...
 */
export const createWorkspace1 = <ThrowOnError extends boolean = false>(options: Options<CreateWorkspace1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateWorkspace1Responses, unknown, ThrowOnError>({
        url: '/workspaces',
        ...options,
        headers: {
            'Content-Type': 'application/json',
