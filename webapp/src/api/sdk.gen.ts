 ...
 */
export const getLatestFeedbackResponse = <ThrowOnError extends boolean = false>(options: Options<GetLatestFeedbackResponseData, ThrowOnError>) => (options.client ?? client).get<GetLatestFeedbackResponseResponses, unknown, ThrowOnError>({
 ...
 *
 * Records usefulness, resolution, or both as a new immutable response snapshot.
 */
