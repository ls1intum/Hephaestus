 ...
 */
export const triggerSyncJob = <ThrowOnError extends boolean = false>(options: Options<TriggerSyncJobData, ThrowOnError>) => (options.client ?? client).post<TriggerSyncJobResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/workspaces/{workspaceSlug}/connections/{connectionId}/sync/jobs',
    ...options,
    headers: {
 ...
 */
export const cancelConnectionSyncJob = <ThrowOnError extends boolean = false>(options: Options<CancelConnectionSyncJobData, ThrowOnError>) => (options.client ?? client).post<CancelConnectionSyncJobResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
