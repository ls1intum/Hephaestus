 ...
 */
export const getIdentityProviders = <ThrowOnError extends boolean = false>(options?: Options<GetIdentityProvidersData, ThrowOnError>) => (options?.client ?? client).get<GetIdentityProvidersResponses, unknown, ThrowOnError>({ url: '/auth/identity-providers', ...options });
 ...
 */
export const getWorkspaceProviders = <ThrowOnError extends boolean = false>(options?: Options<GetWorkspaceProvidersData, ThrowOnError>) => (options?.client ?? client).get<GetWorkspaceProvidersResponses, unknown, ThrowOnError>({ url: '/workspaces/providers', ...options });
