...
import type { ProvideFeedbackForBadPracticeData, ProvideFeedbackForBadPracticeResponses, ResolveBadPracticeData, ResolveBadPracticeResponses, DetectBadPracticesForPullRequestData, DetectBadPracticesForPullRequestResponses, DetectBadPracticesByUserData, DetectBadPracticesByUserResponses, GetActivityByUserData, GetActivityByUserResponses, VoteMessageData, VoteMessageResponses, VoteMessageErrors, GetUserDocumentsData, GetUserDocumentsResponses, CreateDocumentData, CreateDocumentResponses, CreateDocumentErrors, DeleteDocumentData, DeleteDocumentResponses, DeleteDocumentErrors, GetDocumentData, GetDocumentResponses, GetDocumentErrors, UpdateDocumentData, UpdateDocumentResponses, UpdateDocumentErrors, DeleteVersionsAfterTimestampData, DeleteVersionsAfterTimestampResponses, DeleteVersionsAfterTimestampErrors, GetDocumentVersionsData, GetDocumentVersionsResponses, GetDocumentVersionsErrors, GetDocumentVersionData, GetDocumentVersionResponses, GetDocumentVersionErrors, GetAllData, GetAllResponses, GetByIdData, GetByIdResponses, GetLeaderboardData, GetLeaderboardResponses, GetUserLeagueStatsData, GetUserLeagueStatsResponses, GetThreadData, GetThreadResponses, GetThreadErrors, GetThreadsData, GetThreadsResponses, GetThreadsErrors, GetGroupedThreadsData, GetGroupedThreadsResponses, GetGroupedThreadsErrors, GetMetaDataData, GetMetaDataResponses, GetContributorsData, GetContributorsResponses, GetTeamLeaderboardData, GetTeamLeaderboardResponses, GetAllTimeTeamLeaderboardData, GetAllTimeTeamLeaderboardResponses, GetTeamsData, GetTeamsResponses, HideTeamData, HideTeamResponses, DeleteUserData, DeleteUserResponses, GetUserSettingsData, GetUserSettingsResponses, UpdateUserSettingsData, UpdateUserSettingsResponses, GetUserProfileData, GetUserProfileResponses, ResetAndRecalculateLeaguesData, ResetAndRecalculateLeaguesResponses, GetRepositoriesToMonitorData, GetRepositoriesToMonitorResponses, RemoveRepositoryToMonitorData, RemoveRepositoryToMonitorResponses, AddRepositoryToMonitorData, AddRepositoryToMonitorResponses, DeleteTeamData, DeleteTeamResponses, RemoveLabelFromTeamData, RemoveLabelFromTeamResponses, AddLabelToTeamData, AddLabelToTeamResponses, RemoveRepositoryFromTeamData, RemoveRepositoryFromTeamResponses, AddRepositoryToTeamData, AddRepositoryToTeamResponses, CreateTeamData, CreateTeamResponses, AutomaticallyAssignTeamsData, AutomaticallyAssignTeamsResponses, RemoveUserFromTeamData, RemoveUserFromTeamResponses, AddTeamToUserData, AddTeamToUserResponses, GetUsersWithTeamsData, GetUsersWithTeamsResponses } from './types.gen';
...
export const getAllTimeTeamLeaderboard = <ThrowOnError extends boolean = false>(options?: Options<GetAllTimeTeamLeaderboardData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllTimeTeamLeaderboardResponses, unknown, ThrowOnError>({
