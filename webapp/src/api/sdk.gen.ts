 ...
 */
export const claimIdentity = <ThrowOnError extends boolean = false>(options: Options<ClaimIdentityData, ThrowOnError>) => (options.client ?? client).post<unknown, ClaimIdentityErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
