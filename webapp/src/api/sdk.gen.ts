 ...
 */
export const updateReviewCycle = <ThrowOnError extends boolean = false>(options: Options<UpdateReviewCycleData, ThrowOnError>) => (options.client ?? client).patch<UpdateReviewCycleResponses, UpdateReviewCycleErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
