...
/**
 * Send chat message
 * Send a message to the AI mentor and receive a streaming response
 */
...
export const voteMessage = <ThrowOnError extends boolean = false>(options: Options<VoteMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<VoteMessageResponses, unknown, ThrowOnError>({
 ...
 * Retrieve all documents (latest versions only) for the authenticated user
 */
export const getDocuments = <ThrowOnError extends boolean = false>(options: Options<GetDocumentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDocumentsResponses, unknown, ThrowOnError>({
...
export const createDocument = <ThrowOnError extends boolean = false>(options: Options<CreateDocumentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateDocumentResponses, unknown, ThrowOnError>({
        url: '/workspaces/{workspaceSlug}/mentor/documents',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Delete document versions created after a specified timestamp
 */
export const deleteVersionsAfterTimestamp = <ThrowOnError extends boolean = false>(options: Options<DeleteVersionsAfterTimestampData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteVersionsAfterTimestampResponses, unknown, ThrowOnError>({
