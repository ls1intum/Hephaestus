 ...
 */
export const getReflection = <ThrowOnError extends boolean = false>(options: Options<GetReflectionData, ThrowOnError>) => (options.client ?? client).get<GetReflectionResponses, unknown, ThrowOnError>({ url: '/workspaces/{workspaceSlug}/practices/findings/reflection', ...options });
