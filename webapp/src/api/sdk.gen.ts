 ...
 * Returns all pending dead letters, ordered by creation time (oldest first)
 */
export const getPending = <ThrowOnError extends boolean = false>(options?: Options<GetPendingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetPendingResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Returns counts of dead letters by status and event type
 */
export const getStats = <ThrowOnError extends boolean = false>(options?: Options<GetStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetStatsResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Returns full details of a dead letter event for investigation
 */
 ...
 * Marks a dead letter as discarded (will not be retried)
 */
...
/**
 * Retry a dead letter
 * Attempts to re-record the failed activity event
 */
export const retry = <ThrowOnError extends boolean = false>(options: Options<RetryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RetryResponses, RetryErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
