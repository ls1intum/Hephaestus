...
import type { AchievementDTO, AchievementStatus } from "@/components/achievements/types";
 ...
 */
export function useAchievementNotifications(achievements: AchievementDTO[], enabled = true) {
