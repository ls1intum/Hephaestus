...
export function GitLabMergeRequestIcon({ size = 16, className }: GitLabIconProps) {
	return (
		<svg
			width={size}
			height={size}
...
export function GitLabMergeRequestClosedIcon({ size = 16, className }: GitLabIconProps) {
	return (
		<svg
			width={size}
			height={size}
...
export function GitLabMergeIcon({ size = 16, className }: GitLabIconProps) {
	return (
		<svg
			width={size}
			height={size}
 ...
 */
export function GitLabMergeRequestDraftIcon({ size = 16, className }: GitLabIconProps) {
	return <GitLabMergeRequestIcon size={size} className={className} />;
}
