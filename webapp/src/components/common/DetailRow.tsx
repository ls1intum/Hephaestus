...
/**
 * One label/value pair of a detail sheet's `<dl>` — the single row renderer every "inspect this
 * record" surface uses, so a job sheet and an audit sheet read the same way.
 *
