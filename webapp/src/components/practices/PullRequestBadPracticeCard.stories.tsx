...
/**
 * GitLab open merge request with bad practices — uses GitLab MR icon and colors.
 */
export const GitLabDefault: Story = {
	...
	args: {
		...Default.args,
		providerType: "GITLAB",
		htmlUrl: "https://gitlab.com/Artemis/repo/-/merge_requests/12",
	},
};
...
export const GitLabDraftMR: Story = {
	...
	args: {
		...
		providerType: "GITLAB",
		htmlUrl: "https://gitlab.com/Artemis/repo/-/merge_requests/15",
	},
};
