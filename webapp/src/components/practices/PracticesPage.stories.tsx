...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Main page that shows pull requests and allows users to analyze them for coding practices.",
			},
		},
	},
	argTypes: {
...
const mockActivityData: UserPractices = {
	pullRequests: [
		{
			id: 1,
			number: 12,
		...
		},
		{
			...
			isDraft: false,
			isMerged: false,
			labels: [{ id: 3, name: "bug", color: "f00000" }],
			repository: {
				id: 1,
				name: "Artemis",
				nameWithOwner: "ls1intum/Artemis",
