...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"A component that displays different league tier icons based on point thresholds.",
			},
		},
	},
	args: {
...
export const AllLeagueTiers: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Visual comparison of all league tiers displayed together with their respective labels.",
			},
		},
	},
};
