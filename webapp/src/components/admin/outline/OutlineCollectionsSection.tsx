...
export interface OutlineCollectionsSectionProps {
	...
	isLoading: boolean;
	/** The collection list query failed — show a retry panel instead of the empty state. */
	isError?: boolean;
		...
		<div className="space-y-6">
			<div>
				<div className="mb-4 flex items-center justify-between gap-4">
					<h2 className="text-lg font-semibold">Mirrored collections</h2>
						...
						{isLoading ? (
							...
							<div className="space-y-3 rounded-lg border border-destructive/30 bg-destructive/5 p-4">
								<p className="text-sm text-destructive" role="alert">
									We couldn't load the mirrored collections.
								</p>
								{onRetry && (
							...
							<Empty>
								<EmptyHeader>
									...
									<EmptyDescription>
										Pick the Outline collections whose documents should reach practice detection.
										Only what you select is read.
									</EmptyDescription>
								</EmptyHeader>
								<EmptyContent>
									<Button size="sm" onClick={() => setAddOpen(true)}>
