...
<<<<<<<< HEAD:webapp/src/components/admin/practice-catalog/group-visuals.ts
...
>>>>>>>> 9f7bcd795 (feat(webapp): show practice-area standing and its evidence on the profile):webapp/src/components/shared/area-visuals.ts
