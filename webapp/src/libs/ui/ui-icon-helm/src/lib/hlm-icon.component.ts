...
import { ChangeDetectionStrategy, Component, ElementRef, Input, type OnDestroy, PLATFORM_ID, ViewEncapsulation, computed, inject, signal } from '@angular/core';
...
@Component({
  ...
  template: ` <ng-icon [class]="ngIconCls()" [size]="ngIconSize()" [name]="_name()" [color]="_color()" [strokeWidth]="_strokeWidth()" /> `,
  host: {
