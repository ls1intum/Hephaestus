...
export * from './repository.serviceInterface';
...
export const APIS = [LeaderboardService, MessageService, MetaService, RepositoryService, SessionService, TeamService, UserService, WorkspaceService];
