...
export class MetaService implements MetaServiceInterface {
     ...
     */
    public getContributors(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<Contributor>>;
    public getContributors(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<Contributor>>>;
    public getContributors(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<Contributor>>>;
    public getContributors(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/meta/contributors`;
        return this.httpClient.request<Array<Contributor>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
