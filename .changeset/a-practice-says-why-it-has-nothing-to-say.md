...
An area's standing is now read straight off its practices, including the quiet ones, so the summary at the top of an area and the practices beneath it can no longer tell different stories.
