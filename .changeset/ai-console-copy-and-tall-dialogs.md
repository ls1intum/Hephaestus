...
The AI console's warnings now name things that still exist. Turning a model or a connection off, or taking a workspace's access away, said "existing configurations will stop" — configurations were removed in this release. It now says what actually stops: practice detection and Mentor, and what to do to start them again.
