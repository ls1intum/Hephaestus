...
administrators editing the same entry no longer overwrite each other silently.
...
administrator customizes them. A customized entry stays active when a new default arrives; the catalog
shows whether applying the update would change review behavior, wording or guidance, or area
