...
Review settings no longer offers a second, competing way to bind the practice-detection model: it reports which model detection runs on, warns when nothing can run, and links to the AI setup page, which is the single place bindings are edited.
