...
The landing page now pairs a clearer value proposition with a responsive, animated preview of project work, practice feedback, delivery surfaces, and a conversation with Heph. It replaces the scoreboard and unshipped pull-request conversation previously used in the hero. Shared links also include a description and social-card metadata.
