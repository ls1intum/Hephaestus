...
export const chatMutation = (options?: Partial<Options<ChatData>>): UseMutationOptions<ChatResponse, DefaultError, Options<ChatData>> => {
    const mutationOptions: UseMutationOptions<ChatResponse, DefaultError, Options<ChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await chat({
                ...options,
                ...localOptions,
