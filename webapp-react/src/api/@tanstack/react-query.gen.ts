...
import { type Options, removeUserFromTeam, addTeamToUser, createTeam, automaticallyAssignTeams, resetAndRecalculateLeagues, removeRepositoryFromTeam, addRepositoryToTeam, addLabelToTeam, removeRepositoryToMonitor, addRepositoryToMonitor, updateUserSettings, hideTeam, getAllSessions, createNewSession, getMessages, createMessage, getLeaderboard, getUserLeagueStats, detectBadPracticesByUser, detectBadPracticesForPullRequest, resolveBadPractice, provideFeedbackForBadPractice, getUsersWithTeams, getRepositoriesToMonitor, getUserProfile, getUserSettings, getTeams, getMetaData, getContributors, getLastSession, getActivityByUser, deleteTeam, removeLabelFromTeam, deleteUser } from '../sdk.gen';
