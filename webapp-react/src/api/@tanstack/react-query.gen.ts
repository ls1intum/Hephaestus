...
export const createNewSessionQueryKey = (options?: Options<CreateNewSessionData>) => createQueryKey('createNewSession', options);

export const createNewSessionOptions = (options?: Options<CreateNewSessionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: createNewSessionQueryKey(options)
    });
};

export const createNewSessionMutation = (options?: Partial<Options<CreateNewSessionData>>): UseMutationOptions<CreateNewSessionResponse, DefaultError, Options<CreateNewSessionData>> => {
    const mutationOptions: UseMutationOptions<CreateNewSessionResponse, DefaultError, Options<CreateNewSessionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createNewSession({
                ...options,
                ...localOptions,
...
export const getMessagesOptions = (options: Options<GetMessagesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const getTeamLeaderboardQueryKey = (options: Options<GetTeamLeaderboardData>) => createQueryKey('getTeamLeaderboard', options);

export const getTeamLeaderboardOptions = (options: Options<GetTeamLeaderboardData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getTeamLeaderboardQueryKey(options)
    });
};

export const getTeamLeaderboardInfiniteQueryKey = (options: Options<GetTeamLeaderboardData>): QueryKey<Options<GetTeamLeaderboardData>> => createQueryKey('getTeamLeaderboard', options, true);

export const getTeamLeaderboardInfiniteOptions = (options: Options<GetTeamLeaderboardData>) => {
    return infiniteQueryOptions<GetTeamLeaderboardResponse, DefaultError, InfiniteData<GetTeamLeaderboardResponse>, QueryKey<Options<GetTeamLeaderboardData>>, Date | Pick<QueryKey<Options<GetTeamLeaderboardData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<GetTeamLeaderboardData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    after: pageParam
                }
            };
        ...
        queryKey: getTeamLeaderboardInfiniteQueryKey(options)
    });
};

export const getAllTimeTeamLeaderboardQueryKey = (options?: Options<GetAllTimeTeamLeaderboardData>) => createQueryKey('getAllTimeTeamLeaderboard', options);

export const getAllTimeTeamLeaderboardOptions = (options?: Options<GetAllTimeTeamLeaderboardData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAllTimeTeamLeaderboard({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAllTimeTeamLeaderboardQueryKey(options)
    });
};
...
export const getLastSessionQueryKey = (options?: Options<GetLastSessionData>) => createQueryKey('getLastSession', options);

export const getLastSessionOptions = (options?: Options<GetLastSessionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getLastSessionQueryKey(options)
    });
};
