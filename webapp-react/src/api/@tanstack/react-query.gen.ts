...
import { type Options, removeUserFromTeam, addTeamToUser, createTeam, automaticallyAssignTeams, resetAndRecalculateLeagues, deleteDocument, getDocument, updateDocument, removeRepositoryFromTeam, addRepositoryToTeam, addLabelToTeam, removeRepositoryToMonitor, addRepositoryToMonitor, getUserSettings, updateUserSettings, hideTeam, getLeaderboard, getUserLeagueStats, getUserDocuments, createDocument, detectBadPracticesByUser, detectBadPracticesForPullRequest, resolveBadPractice, provideFeedbackForBadPractice, voteMessage, getUsersWithTeams, getRepositoriesToMonitor, getUserProfile, getTeams, getMetaData, getContributors, getThreads, getGroupedThreads, getThread, deleteVersionsAfterTimestamp, getDocumentVersions, getDocumentVersion, getActivityByUser, deleteTeam, removeLabelFromTeam, deleteUser } from '../sdk.gen';
...
import type { RemoveUserFromTeamData, RemoveUserFromTeamResponse, AddTeamToUserData, AddTeamToUserResponse, CreateTeamData, CreateTeamResponse, AutomaticallyAssignTeamsData, ResetAndRecalculateLeaguesData, DeleteDocumentData, DeleteDocumentResponse, GetDocumentData, UpdateDocumentData, UpdateDocumentError, UpdateDocumentResponse, RemoveRepositoryFromTeamData, RemoveRepositoryFromTeamResponse, AddRepositoryToTeamData, AddRepositoryToTeamResponse, AddLabelToTeamData, AddLabelToTeamResponse, RemoveRepositoryToMonitorData, AddRepositoryToMonitorData, GetUserSettingsData, UpdateUserSettingsData, UpdateUserSettingsResponse, HideTeamData, HideTeamResponse, GetLeaderboardData, GetLeaderboardResponse, GetUserLeagueStatsData, GetUserLeagueStatsResponse, GetUserDocumentsData, GetUserDocumentsResponse, CreateDocumentData, CreateDocumentError, CreateDocumentResponse, DetectBadPracticesByUserData, DetectBadPracticesForPullRequestData, ResolveBadPracticeData, ProvideFeedbackForBadPracticeData, VoteMessageData, VoteMessageError, VoteMessageResponse, GetUsersWithTeamsData, GetRepositoriesToMonitorData, GetUserProfileData, GetTeamsData, GetMetaDataData, GetContributorsData, GetThreadsData, GetGroupedThreadsData, GetThreadData, DeleteVersionsAfterTimestampData, DeleteVersionsAfterTimestampError, DeleteVersionsAfterTimestampResponse, GetDocumentVersionsData, GetDocumentVersionsError, GetDocumentVersionsResponse, GetDocumentVersionData, GetActivityByUserData, DeleteTeamData, DeleteTeamResponse, RemoveLabelFromTeamData, RemoveLabelFromTeamResponse, DeleteUserData } from '../types.gen';
