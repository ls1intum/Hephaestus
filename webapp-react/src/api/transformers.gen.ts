...
import type { GetAllSessionsResponse, CreateNewSessionResponse, GetMessagesResponse, CreateMessageResponse, GetLeaderboardResponse, GetUserProfileResponse, GetLastSessionResponse, GetActivityByUserResponse } from './types.gen';
