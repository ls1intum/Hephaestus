...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"A card component for displaying pull request information with options to analyze the code for bad practices.",
			},
		},
	},
	tags: ["autodocs"],
...
export const WithOldPractices: Story = {
	args: {
		...
		badPracticeSummary:
			"We found 1 issue in this pull request. Previous issues have been fixed.",
	},
};
