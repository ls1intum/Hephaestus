...
import { Rocket, Check, Flame, AlertTriangle, Bug, Ban, XOctagon } from "lucide-react";
...
export const stateConfig: {
  ...
  GOOD_PRACTICE: { icon: Rocket, text: "Good Practice", color: "text-github-success-foreground" },
  FIXED: { icon: Check, text: "Fixed", color: "text-github-done-foreground" },
  CRITICAL_ISSUE: { icon: Flame, text: "Critical Issue", color: "text-github-danger-foreground" },
  NORMAL_ISSUE: { icon: AlertTriangle, text: "Normal Issue", color: "text-github-severe-foreground" },
  MINOR_ISSUE: { icon: Bug, text: "Minor Issue", color: "text-github-attention-foreground" },
  WONT_FIX: { icon: Ban, text: "Won't Fix", color: "text-github-muted-foreground" },
  WRONG: { icon: XOctagon, text: "Wrong", color: "text-github-muted-foreground" }
};
