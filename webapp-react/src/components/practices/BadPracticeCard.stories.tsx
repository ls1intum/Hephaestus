...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A card displaying a coding practice with contextual styling based on its current state.',
      },
    },
  },
  argTypes: {
    ...
    state: {
      ...
      control: 'select',
      options: ['GOOD_PRACTICE', 'FIXED', 'CRITICAL_ISSUE', 'NORMAL_ISSUE', 'MINOR_ISSUE', 'WONT_FIX', 'WRONG'],
    },
...
export const GoodPractice: Story = {
  args: {
    ...
    description: "Using the any type defeats the purpose of TypeScript's static typing. Use more specific types instead.",
    state: "GOOD_PRACTICE"
  }
};
...
export const NormalIssue: Story = {
  args: {
    ...
    description: "Deeply nested callbacks create 'callback hell' and make code difficult to read and maintain. Use async/await or Promise chaining instead.",
    state: "NORMAL_ISSUE"
  }
};
...
export const CriticalIssue: Story = {
  args: {
    ...
    description: "This code contains a potential SQL injection vulnerability that could allow attackers to access sensitive data.",
