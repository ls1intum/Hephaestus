...
export const MobileView: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Header in mobile view with collapsed navigation in a hamburger menu and compact controls.',
      },
    },
  },
};
...
export const DesktopView: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Header in desktop view with full horizontal navigation and expanded controls.',
      },
    },
  },
};