...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A simple, honest landing page that presents the Hephaestus platform features and benefits without exaggeration, focusing on the real value it provides to development teams.',
      },
    },
  },
  argTypes: {
