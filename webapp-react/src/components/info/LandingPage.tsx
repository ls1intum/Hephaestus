      ...
      <section className="w-full bg-gradient-to-b from-background to-muted/30 pt-8 md:pt-16 lg:pt-24 text-foreground">
          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            <div className="space-y-4 max-w-3xl">
              ...
              <p className="mx-auto max-w-[700px] text-xl text-muted-foreground">
                Empower engineers, foster collaboration, and build sustainable development practices with our open-source platform.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <div className="shadow-xl border border-muted rounded-md overflow-hidden -mb-3">
            <div className="overflow-auto pointer-events-none" 
                style={{ maskImage: "linear-gradient(to bottom, rgba(0, 0, 0, 1) 50%, rgba(0, 0, 0, 0))" }}>
              <LeaderboardTable 
      ...
      >
        <div className="container px-4 md:px-6">
          <div className="mb-12 text-center max-w-3xl mx-auto">
            <Badge className="mb-4" variant="outline">Key Features</Badge>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Personalized guidance for improvement</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex gap-2 items-start">
                  ...
                  <li className="flex gap-2 items-start">
                    <CheckCheck className="size-5 mt-1 text-github-success-foreground" />
                    <span>GitHub activity analysis for context-aware feedback</span>
                  </li>
                  <li className="flex gap-2 items-start">
                    <CheckCheck className="size-5 mt-1 text-github-success-foreground" />
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-[1fr_500px] lg:gap-12">
            ...
            <div className="flex flex-col justify-center space-y-5">
              <Badge className="w-fit" variant="outline">Our Approach</Badge>
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Why Choose Hephaestus?</h2>
              <p className="text-lg text-muted-foreground">
                Named after the Greek god of craftsmen, Hephaestus combines creativity with technical expertise to build better development teams.
              </p>
              ...
              <ul className="grid gap-4 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Tools that accelerate learning through real-world feedback</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Build team habits that strengthen your engineering culture</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Motivate better code reviews through friendly competition</p>
                  </div>
                </li>
              </ul>
      ...
      <section id="testimonials" className="w-full py-8 md:py-16 bg-background">
        <div className="container px-4 md:px-6">
          <div className="mb-8 text-center max-w-3xl mx-auto">
            <Badge className="mb-4" variant="outline">Testimonial</Badge>
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-4">From Our Community</h2>
          </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="border-l-4 border-primary pl-4 py-2 italic mb-4">
                  "I heavily use Hephaestus to see how our team is doing. It helps me write all the things I've accomplished when it's time to fill a weekly report."
                </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-6 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-secondary">
              Join our community and build more collaborative and effective software development practices.
            </p>
            ...
            {!isSignedIn && (
              <p className="text-sm text-secondary pt-2">Open-source and free to use.</p>
            )}
          </div>
        </div>
      </section>
