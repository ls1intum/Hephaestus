...
import { AlertCircle, Hammer, Github, Globe, Code, Users, Sparkles, MessageSquare } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <section className="mb-16 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Named after the Greek craftsman of the gods, we forge powerful tools that transform how software
          teams collaborate, learn, and excel together.
        </p>
      </section>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            <p className="text-lg leading-relaxed">
              We empower novice software engineers and foster sustainable, collaborative development practices through smart
              gamification and AI guidance that adapts to your team's unique challenges.
            </p>
            
            <div className="border-l-4 border-primary pl-6 py-2">
              <p className="text-lg font-medium">
                We believe the best software isn't just about writing code — it's about building teams that bring out the best
                in each other.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          <Card className="bg-gradient-to-br from-background to-muted/50 border-muted">
            <CardHeader>
              ...
              <CardDescription>Turning technical work into team growth</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Transform code reviews into engaging experiences with dynamic leaderboards, team competitions, and a structured league
                system that recognizes excellence and encourages participation from developers at all skill levels.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-background to-muted/50 border-muted">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Receive contextual guidance through our AI mentor that provides personalized feedback, identifies growth opportunities, 
                and helps team members develop their skills with practical insights that lead to measurable improvement.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="mb-20">
        <Badge className="mb-4" variant="outline">Our People</Badge>
        ...
        <div className="bg-gradient-to-br from-background to-muted/30 rounded-lg p-8 mb-16 border border-muted">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-muted-foreground">
                Forging Hephaestus from concept to reality, Felix combines technical mastery with a passion for creating
                tools that empower software teams to achieve their full potential through data-driven insights and collaborative learning.
              </p>
        ...
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground mb-8">
            These talented individuals have contributed their skills to help shape Hephaestus into what it is today.
            Each contributor brings unique expertise that strengthens our platform.
          </p>
          ...
          {isError && (
            <div className="bg-gradient-to-br from-background to-muted/30 rounded-lg p-8 text-center border border-muted">
              ...
              <p className="text-muted-foreground">
                We're having trouble reaching our contributor information. Our team is working on it—please check back soon!
              </p>
            </div>
          )}
              ...
              {otherContributors.length > 0 ? (
                ...
                <div className="col-span-full bg-gradient-to-br from-background to-muted/30 rounded-lg p-8 text-center border border-muted/50">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Our forge is warming up! Be the first to join our contributor community and help shape the future of Hephaestus.
                  </p>
                  <Button asChild>
                    <a
      ...
      <section className="mt-20 mb-8 bg-gradient-to-br from-background to-muted/30 rounded-lg p-8 text-center border border-muted/50">
        <Badge className="mb-4" variant="outline">Get Involved</Badge>
        <h2 className="text-3xl font-bold mb-4">Ready to Forge Something Great?</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
          Hephaestus thrives on community contributions from developers of all skill levels. 
          Whether you're fixing bugs, adding features, or improving documentation, your expertise helps shape our platform.
        </p>
