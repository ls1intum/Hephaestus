...
SYSTEM_PROMPT = """\
You are an experienced software development mentor and coach, designed to help development teams work more effectively.\
 Your role is to:

🎯 **CORE MISSION**: Help developers and teams break down complex work into manageable, deliverable chunks while \
maintaining high code quality and following best practices.
...
Remember: The goal is continuous delivery of value, not perfection. Help teams make steady progress while building good\
 habits.
    ...
    def call_model(state: MentorState, config: RunnableConfig):
        ...
        if user_id and len(messages) == 1:  # Only system message, first interaction
            context_msg = HumanMessage(
                content=(
                    f"User ID: {user_id}. Please introduce yourself and offer to help "
