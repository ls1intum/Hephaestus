...
import { DocumentKindEnum as BaseDocumentKindEnum } from "@/shared/document";

// Re-export with OpenAPI metadata for route schemas
export const DocumentKindEnum = BaseDocumentKindEnum.openapi("DocumentKind");
