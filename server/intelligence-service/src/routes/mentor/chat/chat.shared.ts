...
// Note: We define getWeather schemas here instead of importing from @/lib/ai/tools/get-weather
...
const getWeatherTypeHelper = tool({
	...
	execute: async () =>
		({ success: true as const }) as z.infer<typeof getWeatherOutputSchema>,
});
 ...
 * Returns the typed output or undefined if invalid.
 */
export function parseCreateDocumentOutput(
	output: unknown,
): CreateDocumentOutput | undefined {
 ...
 * Returns the typed input or undefined if invalid.
 */
export function parseUpdateDocumentInput(
	input: unknown,
): UpdateDocumentInput | undefined {
 ...
 * Returns the typed output or undefined if invalid.
 */
export function parseUpdateDocumentOutput(
	output: unknown,
): UpdateDocumentOutput | undefined {
