...
public class TeamService {
    ...
    public void setupDefaultTeams() {
        ...
        defaultTeams.add(new DefaultTeamRecord("Hephaestus", "#69feff", List.of(new RepositoryWithLabels("ls1intum/Hephaestus", List.of()))));
        defaultTeams.add(new DefaultTeamRecord("Communication", "#69feff", List.of(new RepositoryWithLabels("ls1intum/Artemis", List.of("communication", "component:communication")))));
        defaultTeams.add(new DefaultTeamRecord("Lectures", "#69feff", List.of(new RepositoryWithLabels("ls1intum/Artemis", List.of("lecture", "Component:Lecture")))));
        defaultTeams.add(new DefaultTeamRecord("Usability", "#69feff", List.of(new RepositoryWithLabels("ls1intum/Artemis", List.of()))));
        defaultTeams.add(new DefaultTeamRecord("Ares", "#69feff", List.of(new RepositoryWithLabels("ls1intum/Ares", List.of()), new RepositoryWithLabels("ls1intum/Ares2", List.of()))));
        ...
        for (DefaultTeamRecord defaultTeam : defaultTeams) {
            ...
            defaultTeam.repositories().forEach(repositoryWithLabels -> {
                ...
                repositoryWithLabels.labels().forEach(labelName -> labelRepository.findByRepositoryIdAndName(repository.get().getId(), labelName).ifPresent(team::addLabel));
            });
    ...
    private record DefaultTeamRecord (
        String name,
        String color,
        List<RepositoryWithLabels> repositories
    ) {}

    private record RepositoryWithLabels (
