...
public class GitHubDiscussionProcessor extends BaseGitHubProcessor {
    ...
    /**
     * Find or create a discussion category.
     * <p>
    ...
    private DiscussionCategory findOrCreateCategory(GitHubDiscussionCategoryDTO dto, Repository repository) {
        ...
        Optional<DiscussionCategory> existingOpt = categoryRepository.findById(dto.nodeId());
        ...
        category.setSlug(dto.slug() != null ? dto.slug() : dto.name().toLowerCase().replace(' ', '-'));
        category.setEmoji(dto.emoji());
        category.setDescription(dto.description());
        category.setAnswerable(dto.isAnswerable());
