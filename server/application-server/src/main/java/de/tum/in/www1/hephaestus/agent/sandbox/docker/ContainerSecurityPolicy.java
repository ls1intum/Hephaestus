...
public class ContainerSecurityPolicy {
  ...
  public DockerOperations.HostConfigSpec buildHostConfig(
      SecurityProfile security, ResourceLimits resources, NetworkPolicy networkPolicy) {
    // Security options
    ...
    // Ulimits
    Map<String, DockerOperations.UlimitSpec> ulimits =
        Map.of("nofile", new DockerOperations.UlimitSpec(NOFILE_LIMIT, NOFILE_LIMIT));
