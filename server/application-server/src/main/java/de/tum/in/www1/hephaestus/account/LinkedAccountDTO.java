...
public record LinkedAccountDTO(
    @Schema(
        description = "Identity provider alias (e.g. 'github', 'gitlab-lrz')",
        requiredMode = Schema.RequiredMode.REQUIRED
    )
    String providerAlias,
    @Schema(description = "Display name of the identity provider", requiredMode = Schema.RequiredMode.REQUIRED)
    String providerName,
    @Schema(description = "Whether the user has linked this provider", requiredMode = Schema.RequiredMode.REQUIRED)
    boolean connected,
