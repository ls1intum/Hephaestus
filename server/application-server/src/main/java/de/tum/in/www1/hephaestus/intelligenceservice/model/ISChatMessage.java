 ...
 */
@JsonPropertyOrder({
  ISChatMessage.JSON_PROPERTY_CONTENT,
  ISChatMessage.JSON_PROPERTY_SENDER
})
@JsonTypeName("ChatMessage")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.7.0")
public class ISChatMessage {
  ...
  public ISChatMessage content(String content) {
  ...
  public ISChatMessage sender(String sender) {
  ...
  public boolean equals(Object o) {
    ...
    ISChatMessage chatMessage = (ISChatMessage) o;
