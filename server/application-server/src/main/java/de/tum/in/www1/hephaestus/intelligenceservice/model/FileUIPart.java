 ...
 */
@JsonPropertyOrder({
  FileUIPart.JSON_PROPERTY_DATA,
  FileUIPart.JSON_PROPERTY_MIME_TYPE,
...
public class FileUIPart {
  ...
  public FileUIPart data(String data) {
  ...
  public FileUIPart mimeType(String mimeType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, fileUIPart.data) &&
        Objects.equals(this.mimeType, fileUIPart.mimeType) &&
        Objects.equals(this.type, fileUIPart.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, mimeType, type);
  }
