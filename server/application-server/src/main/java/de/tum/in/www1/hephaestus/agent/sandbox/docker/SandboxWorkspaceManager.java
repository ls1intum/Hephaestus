 ...
 *
 * <p>Uses {@code docker cp} (tar archive API) for all file transfers —
 * no bind mounts. This works identically for local and remote Docker
 * daemons, enabling future multi-node runner support.
 */
