 ...
 * published by the activity module and evaluates whether the user has unlocked new achievements.
 *
 * <h3>Core Components</h3>
 * <ul>
 *   <li>{@link AchievementType} - Enum defining all achievements (source of truth)</li>
 *   <li>{@link UserAchievement} - JPA entity tracking unlocked achievements per user</li>
 *   <li>{@link AchievementService} - Business logic for checking and unlocking achievements</li>
 ...
 *     ↓
 * AchievementService.checkAndUnlock() evaluates achievements
 * </pre>
 *
