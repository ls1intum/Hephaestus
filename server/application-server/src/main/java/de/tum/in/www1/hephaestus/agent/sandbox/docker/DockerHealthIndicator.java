 ...
 *
 * <p>Pings the Docker daemon and reports UP/DOWN status with operational
 * details (active container count, capacity). Intended for readiness probes,
 * not liveness — a Docker outage should prevent new job acceptance but
 * should not restart the app-server.
 */
