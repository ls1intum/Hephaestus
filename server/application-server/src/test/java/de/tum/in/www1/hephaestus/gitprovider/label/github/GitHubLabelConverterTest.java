...
class GitHubLabelConverterTest extends BaseUnitTest {
    ...
    void shouldConvertGitHubEditedLabelPayloadPreservingUpdates(
        ...
        assertThat(result)
            ...
            .containsExactly(ghLabel.getId(), ghLabel.getName(), ghLabel.getColor(), ghLabel.getDescription());
    }
    ...
    void shouldConvertGitHubDeletedLabelPayloadForCleanupOperations(
        ...
        assertThat(result)
            ...
            .satisfies(label -> {
                assertThat(label.getId()).as("ID must be preserved for deletion operations").isEqualTo(ghLabel.getId());
                assertThat(label.getName()).as("Name must be preserved for audit trail").isEqualTo(ghLabel.getName());
            });
    }
    ...
    void shouldUpdateExistingLabelInstanceWithNewGitHubData(
        ...
        // Then
        assertThat(result).as("Should return the same instance for object identity").isSameAs(existingLabel);
