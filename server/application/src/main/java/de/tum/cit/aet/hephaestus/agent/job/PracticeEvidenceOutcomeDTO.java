...
public record PracticeEvidenceOutcomeDTO(
        @NonNull @Schema(description = "Practice this outcome describes")
        String practiceSlug,

        @NonNull @Schema(description = "Reviews that considered this practice")
        Integer consideredReviews,

        @NonNull @Schema(description = "Reviews where the evidence met every requirement")
        Integer reviewedCount,

        @NonNull @Schema(description = "Blockers seen on the skipped reviews, most frequent first")
    ...
    public record PracticeEvidenceBlockerDTO(
            ...
            @NonNull @Schema(description = "Readiness reason recorded for that source or practice")
            PracticeEvidenceSkipReason reasonCode,

            @NonNull @Schema(description = "Reviews this blocker affected")
            Integer reviewsAffected) {}
}
