...
public record UpdateLeaderboardDigestRequestDTO(
        ...
        @Schema(description = "Team name for filtering leaderboard notifications") @Nullable
        String team,

        @Pattern(
                regexp = "^[CG][A-Z0-9]{8,}$",
                message =
                        "Channel ID must start with 'C' (public) or 'G' (private) followed by at least 8 alphanumeric characters")
