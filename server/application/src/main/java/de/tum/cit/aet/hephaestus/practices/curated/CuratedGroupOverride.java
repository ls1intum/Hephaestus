...
@Entity
@Table(name = "curated_group_override")
@Getter
@NoArgsConstructor
@EqualsAndHashCode(onlyExplicitlyIncluded = true)
public class CuratedGroupOverride {
    ...
    public CuratedGroupOverride(String slug, Instant now) {
        this.slug = Objects.requireNonNull(slug, "slug");
        this.createdAt = Objects.requireNonNull(now, "now");
        this.updatedAt = now;
    }

    public @Nullable GroupDefinition definition() {
        if (name == null) {
            return null;
        }
    ...
    public void write(GroupDefinition definition, @Nullable String acceptedBundledDigest, Instant now) {
