...
public record ProfileActivityMonitorDTO(
        @NonNull @Schema(description = "Aggregated activity stats after applying monitor filters")
        ProfileActivityStatsDTO activityStats,

        @NonNull @Schema(description = "Review activity entries after applying monitor filters and limit")
        ...
        @NonNull @Schema(description = "Repositories with monitor-relevant activity in the selected timeframe")
        List<RepositoryInfoDTO> repositories,

        @NonNull @Schema(description = "Total review activity entries after filters, before limit")
        Integer totalReviewActivityCount,

        @NonNull @Schema(description = "Total open authored pull requests after filters, before limit")
