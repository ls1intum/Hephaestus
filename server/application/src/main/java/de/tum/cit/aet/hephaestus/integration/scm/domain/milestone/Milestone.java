package de.tum.cit.aet.hephaestus.integration.scm.domain.milestone;
...
@Table(
        ...
        uniqueConstraints = {
            @UniqueConstraint(
                    name = "uk_milestone_number_repository",
                    columnNames = {"number", "repository_id"}),
            @UniqueConstraint(
                    name = "uq_milestone_provider_native_id",
