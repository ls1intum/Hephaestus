...
public record AdminWorkspaceLlmUsageDTO(
    @NonNull
    @Schema(description = "Addresses the workspace everywhere else in the API, including its cap")
    ...
    @NonNull
    @Schema(description = "The same verdict for the workspace's own-provider spend against its own cap.")
    ...
    @NonNull
    @Schema(description = "Whether work on the workspace's OWN provider is paused right now.")
