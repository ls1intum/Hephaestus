...
public record GitLabGroupDTO(
        @NonNull @Schema(description = "GitLab group numeric ID")
        Long id,

        @NonNull @Schema(description = "Group display name") String name,

        @NonNull @Schema(description = "Full group path including parent groups", example = "my-org/my-team")
        String fullPath,

        @Nullable @Schema(description = "Group avatar URL") String avatarUrl,
        @Nullable @Schema(description = "Group web URL") String webUrl,

        @Nullable @Schema(description = "Group visibility: public, internal, or private")
        String visibility) {}
