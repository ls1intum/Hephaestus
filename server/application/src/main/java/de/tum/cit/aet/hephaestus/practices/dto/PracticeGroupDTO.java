...
public record PracticeGroupDTO(
        ...
        @NonNull @Schema(description = "URL-safe identifier unique within the workspace")
        String slug,

        @NonNull @Schema(description = "Human-readable name")
        String name,

        @Nullable @Schema(description = "What this group develops")
        String description,

        @Nullable @Schema(description = "Optional lucide icon name for the group's chip")
        String icon,

        @Nullable @Schema(description = "Optional palette colour key for the group's chip")
        String color,

        @NonNull @Schema(description = "Whether this group is shown in practice dashboards")
        Boolean visibleInPracticeDashboards,

        @NonNull @Schema(description = "Sort order within the workspace")
        ...
        @NonNull @Schema(description = "Timestamp when the group was created")
        Instant createdAt,

        @Nullable @Schema(description = "Timestamp when the group was last updated")
        Instant updatedAt,

        @Nullable CatalogOriginDTO catalogOrigin) {
    public static PracticeGroupDTO from(
            PracticeGroup group, @Nullable CatalogOriginDTO catalogOrigin, PracticeAutonomy workspaceDefault) {
