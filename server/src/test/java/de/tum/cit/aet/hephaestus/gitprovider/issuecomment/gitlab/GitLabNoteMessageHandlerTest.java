package de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab;
...
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.GitLabEventType;
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.GitLabWebhookContextResolver;
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.dto.GitLabWebhookProject;
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.dto.GitLabWebhookUser;
import de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab.dto.GitLabNoteEventDTO;
import de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab.dto.GitLabNoteEventDTO.EmbeddedIssue;
import de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab.dto.GitLabNoteEventDTO.EmbeddedMergeRequest;
...
import de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewcomment.gitlab.GitLabDiffNoteWebhookProcessor;
...
class GitLabNoteMessageHandlerTest extends BaseUnitTest {
    ...
    @Mock
    private de.tum.cit.aet.hephaestus.gitprovider.pullrequest.gitlab.GitLabMergeRequestProcessor mergeRequestProcessor;

    @Mock
    private GitLabWebhookContextResolver contextResolver;

    @Mock
    private de.tum.cit.aet.hephaestus.gitprovider.pullrequest.PullRequestRepository pullRequestRepository;

    @Mock
    private de.tum.cit.aet.hephaestus.gitprovider.user.UserRepository userRepository;
