...
class GitLabMergeRequestProcessorTest extends BaseUnitTest {
    ...
    private de.tum.cit.aet.hephaestus.integration.gitlab.common.dto.GitLabWebhookProject createProject() {
        return new de.tum.cit.aet.hephaestus.integration.gitlab.common.dto.GitLabWebhookProject(
            278964L,
            "gitlab",
