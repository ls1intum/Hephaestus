package de.tum.cit.aet.hephaestus.gitprovider.issue.gitlab;
...
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.dto.GitLabWebhookLabel;
...
import de.tum.cit.aet.hephaestus.gitprovider.issue.gitlab.dto.GitLabIssueEventDTO;
...
class GitLabIssueProcessorTest extends BaseUnitTest {
    ...
    private de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.dto.GitLabWebhookProject createProject() {
        return new de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.dto.GitLabWebhookProject(
            246765L,
            "demo-repository",
