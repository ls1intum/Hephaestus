...
class SlackWebhookSignatureVerifierTest extends BaseUnitTest {
    ...
    void urlVerificationEchoesChallenge() {
        ...
        WebhookRequest req = new WebhookRequest(body, Map.of(), null, null);
    ...
    void validSignatureWithFreshTimestampVerifies() {
        ...
        WebhookRequest req = new WebhookRequest(body.getBytes(StandardCharsets.UTF_8), headers, null, null);
