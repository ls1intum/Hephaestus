...
class OutlineCredentialProviderTest extends BaseUnitTest {
    ...
    void activeConnection_decryptsOAuthSession() {
        ...
        OAuthSession session = new OAuthSession("access-abc", "refresh-xyz", Instant.parse("2030-01-01T00:00:00Z"));
        connection.setCredentials(session, converter);
        connection.setState(IntegrationState.ACTIVE);
        when(connectionService.findActive(workspaceId, IntegrationKind.OUTLINE)).thenReturn(Optional.of(connection));
