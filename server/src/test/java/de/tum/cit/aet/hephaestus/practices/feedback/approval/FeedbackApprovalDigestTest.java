...
class FeedbackApprovalDigestTest {
    ...
    void bindsTheDecisionToTheExactRevisionPracticesBodiesAnchorsAndOrder() {
        ...
        assertThat(
            List.of(
                proposal("revision-b", original.getProposedPracticeSlugs(), original.getProposedPlacements()),
                ...
                proposal("revision-a", original.getProposedPracticeSlugs(), original.getProposedPlacements().reversed())
            )
                .stream()
