...
class MentorAspectQueryRepositoryIntegrationTest extends BaseIntegrationTest {
    ...
    @Autowired
    private MentorAspectQueryRepository queryRepository;
    ...
    void setUp() {
        ...
        workspace.setWorkspaceSlug("mentor-aspect-q");
        workspace.setDisplayName("Mentor Aspect Query Workspace");
        workspace.setAccountLogin("mentor-aspect-org");
        ...
        user.setLogin("aspect-tester");
        user.setName("Aspect Tester");
        user.setAvatarUrl("https://example.com/a.png");
        user.setHtmlUrl("https://gitlab.com/aspect-tester");
    ...
    void excludesThreadsFromOtherWorkspaces() {
        ...
        other.setWorkspaceSlug("other-aspect-ws");
