 ...
 * {@code *ContentSource} in {@code ..agent.context.providers.mentor..} (matched by name pattern,
 ...
 */
class MentorContentSourceArchitectureTest extends HephaestusArchitectureTest {
