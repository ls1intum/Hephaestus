 ...
 *
 * <p>{@code mentorEnabled} and {@code healthVisibility} are captured here so per-request mentor and
 * practice controllers can decide access without re-loading the {@link Workspace} entity — the filter
 ...
 * @param healthVisibility Who may see the anonymised practice-health aggregate (a privacy control)
