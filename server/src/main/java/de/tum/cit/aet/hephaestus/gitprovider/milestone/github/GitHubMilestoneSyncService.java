package de.tum.cit.aet.hephaestus.gitprovider.milestone.github;
...
import de.tum.cit.aet.hephaestus.gitprovider.graphql.github.model.GHMilestoneConnection;
...
import de.tum.cit.aet.hephaestus.gitprovider.milestone.github.dto.GitHubMilestoneDTO;
        ...
        try {
            ...
            while (hasNextPage) {
                ...
                for (var graphQlMilestone : response.getNodes()) {
                    ...
                    Milestone milestone = milestoneProcessor.process(dto, repository, creatorDto, context);
                    if (milestone != null) {
