 ...
 * ("this verdict rests on 12 pull requests"), not a score. The source set is {@link WorkArtifact}, so a
...
public record FeedbackSourceCountDTO(
    @NonNull @Schema(description = "The kind of work the feedback came from") WorkArtifact source,
