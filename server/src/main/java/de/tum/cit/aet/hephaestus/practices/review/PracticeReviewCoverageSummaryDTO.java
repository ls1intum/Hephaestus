...
public record PracticeReviewCoverageSummaryDTO(
    @Schema(description = "Monitored repositories admitted by the repository coverage axis")
    @NonNull
    Integer coveredRepositories,
    @Schema(description = "Repositories currently monitored by the workspace") @NonNull Integer monitoredRepositories,
    @Schema(description = "Eligible linked members admitted by the people coverage axis")
    @NonNull
