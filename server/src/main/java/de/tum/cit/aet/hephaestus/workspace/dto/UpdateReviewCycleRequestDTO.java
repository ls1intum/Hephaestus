...
/**
 * DTO for updating a workspace's weekly practice review cycle schedule.
 * Day: 1=Monday, 2=Tuesday, ..., 7=Sunday
 * Time: Format "HH:mm" (24-hour format)
 */
@Schema(description = "Request to update the weekly practice review cycle schedule")
public record UpdateReviewCycleRequestDTO(
