...
/**
 * Reports {@code UP} only when the NATS connection is CONNECTED and both target streams
 * ({@code gitlab}, {@code github}) are reachable. Exception messages stay in the log; only the
