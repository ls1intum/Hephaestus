 ...
 * {@link de.tum.cit.aet.hephaestus.practices} module. This separation follows DDD principles
 ...
 * <ul>
 *   <li>{@link de.tum.cit.aet.hephaestus.activity.ActivityEvent} - Immutable event entity</li>
 *   <li>{@link de.tum.cit.aet.hephaestus.activity.ActivityEventListener} - Domain→Activity bridge</li>
 *   <li>{@link de.tum.cit.aet.hephaestus.activity.ActivityEventService} - Event persistence</li>
 *   <li>{@link de.tum.cit.aet.hephaestus.activity.scoring.ExperiencePointCalculator} - XP formulas</li>
 * </ul>
 *
 ...
 *
 * <h2>Event Types</h2>
 * <p>See {@link de.tum.cit.aet.hephaestus.activity.ActivityEventType} for supported types.
 *
 * @see de.tum.cit.aet.hephaestus.practices Code Health module (agent-based practice review)
