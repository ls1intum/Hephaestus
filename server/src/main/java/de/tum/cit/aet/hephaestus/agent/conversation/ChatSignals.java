 ...
 * a vendor's name behind an identifier a second messaging integration is meant to reuse — the mistake
 * the old {@code SubjectClass.SLACK_MESSAGE_THREAD} spelling made.
 */
public final class ChatSignals {
     ...
     * decides it instead. Before this existed the three conversation practices carried an empty trigger
     * list and were reviewed anyway, so nothing in the catalog said what started them.
     */
