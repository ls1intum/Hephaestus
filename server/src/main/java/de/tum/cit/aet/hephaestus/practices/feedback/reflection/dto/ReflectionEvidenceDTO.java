...
/**
 * One piece of work that carries the habit a reflection message is about.
 *
 ...
 * work itself; repeating it would make the reflection surface a second copy of the pull-request comment
...
public record ReflectionEvidenceDTO(
    ...
    public static ReflectionEvidenceDTO from(Observation observation) {
        ArtifactKind kind = observation.getArtifactKind();
        return new ReflectionEvidenceDTO(
