/**
 * Practice-finding reactions (APPLIED / DISPUTED / NOT_APPLICABLE) — the developer's response to a finding,
 * the closed-loop research signal. Carries each reaction's {@code correlation_key} (ADR 0021 A2) so it
