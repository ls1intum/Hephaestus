...
import static de.tum.cit.aet.hephaestus.integration.github.common.GitHubSyncConstants.ISSUE_SYNC_PAGE_SIZE;
...
import de.tum.cit.aet.hephaestus.integration.github.issuecomment.GitHubIssueCommentSyncService;
...
public class GitHubIssueSyncService {
    ...
    public GitHubIssueSyncService(
        ...
        de.tum.cit.aet.hephaestus.integration.github.project.GitHubProjectItemSyncService projectItemSyncService,
