 ...
 * Local git clones of exclusively-monitored repositories are cleaned up as part of this work: the
 * eraser routes through {@code WorkspaceRepositoryMonitorService#deleteRepositoryIfOrphaned}, which
 * deletes the clone under the same exclusivity check before deleting the repository row.
 *
