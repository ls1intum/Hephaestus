...
public record ReviewProposedPlacementDTO(
    ...
    @NonNull String body,
    @Schema(description = "Head-side file path; null for the summary") @Nullable String path,
    @Schema(description = "First 1-based line; null for the summary") @Nullable Integer startLine,
    @Schema(description = "Last 1-based line; null for a single-line comment or summary") @Nullable Integer endLine
) {
