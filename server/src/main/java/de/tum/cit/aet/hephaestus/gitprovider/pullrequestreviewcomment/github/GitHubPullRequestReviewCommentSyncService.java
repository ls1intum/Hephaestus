package de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewcomment.github;

import static de.tum.cit.aet.hephaestus.core.LoggingUtils.sanitizeForLog;
import static de.tum.cit.aet.hephaestus.gitprovider.common.github.GitHubGraphQlErrorUtils.isNotFoundError;
import static de.tum.cit.aet.hephaestus.gitprovider.common.github.GitHubSyncConstants.DEFAULT_PAGE_SIZE;
...
import de.tum.cit.aet.hephaestus.gitprovider.common.github.GitHubRepositoryNameParser;
...
import de.tum.cit.aet.hephaestus.gitprovider.graphql.github.model.GHDiffSide;
...
import de.tum.cit.aet.hephaestus.gitprovider.graphql.github.model.GHPullRequestReviewThread;
...
import de.tum.cit.aet.hephaestus.gitprovider.pullrequest.github.dto.GitHubReviewThreadDTO;
import de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewcomment.PullRequestReviewComment;
import de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewcomment.github.dto.GitHubPullRequestReviewCommentEventDTO.GitHubReviewCommentDTO;
 ...
 *
 * @see de.tum.cit.aet.hephaestus.gitprovider.pullrequest.github.GitHubPullRequestSyncService
 */
                    ...
                    .retryWhen(
                        Retry.backoff(TRANSPORT_MAX_RETRIES, TRANSPORT_INITIAL_BACKOFF)
                            ...
                            .doBeforeRetry(signal ->
                                log.warn(
                                    "Retrying review comment sync after transport error: prNumber={}, page={}, attempt={}, error={}",
                                    pullRequest.getNumber(),
                                    currentPage,
                ...
                ClientGraphQlResponse response = Mono.defer(() ->
                    ...
                    .retryWhen(
                        Retry.backoff(TRANSPORT_MAX_RETRIES, TRANSPORT_INITIAL_BACKOFF)
                            ...
                            .doBeforeRetry(signal ->
                                log.warn(
                                    "Retrying thread comments fetch after transport error: threadId={}, page={}, attempt={}, error={}",
                                    threadNodeId,
                                    currentPage,
                                    signal.totalRetries() + 1,
                                    signal.failure().getMessage()
            ...
            .orElseGet(() -> {
                ...
                if (threadDto.isResolved()) {
                    ...
                    if (resolvedByDto != null) {
                        de.tum.cit.aet.hephaestus.gitprovider.user.User resolvedBy = userProcessor.ensureExists(
                            resolvedByDto,
                ...
                ClientGraphQlResponse graphQlResponse = Mono.defer(() ->
                    ...
                    .retryWhen(
                        Retry.backoff(TRANSPORT_MAX_RETRIES, TRANSPORT_INITIAL_BACKOFF)
                            ...
                            .doBeforeRetry(signal ->
                                log.warn(
                                    "Retrying remaining thread sync after transport error: prNumber={}, page={}, attempt={}, error={}",
                                    pullRequest.getNumber(),
                                    currentPage,
                                    signal.totalRetries() + 1,
                                    signal.failure().getMessage()
