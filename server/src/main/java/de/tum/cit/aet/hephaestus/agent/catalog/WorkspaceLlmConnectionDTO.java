...
public record WorkspaceLlmConnectionDTO(
    ...
    @NonNull @Schema(description = "Auth header name", example = "Authorization") String authHeaderName,
    @NonNull @Schema(description = "Auth value prefix", example = "Bearer ") String authValuePrefix,
    ...
    @Schema(description = "Azure API version, if applicable") String azureApiVersion,
