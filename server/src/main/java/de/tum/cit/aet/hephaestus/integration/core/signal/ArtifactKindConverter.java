 ...
 *
 * <p>Reading validates: a row whose value no longer parses fails loudly here rather than flowing into
 * the application as a kind nothing declares. That is the point of storing a grammar-checked
 * vocabulary — a value that got into the column by some other route is a bug we want to hear about.
 */
