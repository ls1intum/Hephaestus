 ...
 *
 * <p>The synthesised per-practice report cards, the mentor roster and the anonymised workspace-health
 * rollup live on the sibling {@code /practices/reports} and {@code /practices/health} resources — see
