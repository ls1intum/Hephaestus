 ...
 *
 * <p>The synthesised per-developer report cards and the anonymised workspace health rollup live on the
 * sibling {@code /practices/reports} + {@code /practices/health} resources (see
