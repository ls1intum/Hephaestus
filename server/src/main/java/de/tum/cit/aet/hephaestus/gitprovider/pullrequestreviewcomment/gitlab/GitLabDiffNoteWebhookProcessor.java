package de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewcomment.gitlab;
...
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.BaseGitLabProcessor;
import de.tum.cit.aet.hephaestus.gitprovider.common.gitlab.GitLabFieldUtils;
...
import de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab.dto.GitLabNoteEventDTO;
import de.tum.cit.aet.hephaestus.gitprovider.issuecomment.gitlab.dto.GitLabNoteEventDTO.NoteAttributes;
...
import de.tum.cit.aet.hephaestus.gitprovider.pullrequestreview.gitlab.GitLabReviewReconciler;
...
import de.tum.cit.aet.hephaestus.gitprovider.pullrequestreviewthread.gitlab.GitLabPullRequestReviewThreadProcessor;
...
import de.tum.cit.aet.hephaestus.gitprovider.user.gitlab.GitLabUserService;
...
public class GitLabDiffNoteWebhookProcessor extends BaseGitLabProcessor {
    ...
    private PullRequest createMinimalPullRequest(
        ...
        de.tum.cit.aet.hephaestus.gitprovider.repository.Repository repository = context.repository();
        if (repository == null || dto.id() == null) return null;

        de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State mappedState = convertMrState(dto.state());
        ...
        pr.setMerged(mappedState == de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State.MERGED);
        pr.setAdditions(0);
        pr.setDeletions(0);
    ...
    private static de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State convertMrState(@Nullable String state) {
        if (state == null) return de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State.OPEN;
        return switch (state.toLowerCase()) {
            case "opened" -> de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State.OPEN;
            ...
            default -> de.tum.cit.aet.hephaestus.gitprovider.issue.Issue.State.OPEN;
        };
    }
}
