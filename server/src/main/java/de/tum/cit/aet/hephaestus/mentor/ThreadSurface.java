 ...
 * {@code chat_thread.surface}, value-constrained by {@code chk_chat_thread_surface}. See
 * {@code .ai/notes/slack-integration-design.md} (D7).
 */
public enum ThreadSurface {
    /** The webapp mentor over an HTTP {@code text/event-stream}. Default for every thread created today. */
    WEB,
    /** A Slack direct-message mentor thread, mapped via {@code mentor_slack_thread} (P2). */
    SLACK_DM,
}
