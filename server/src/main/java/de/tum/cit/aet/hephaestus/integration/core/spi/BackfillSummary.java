 ...
 * @param completedThrough  the oldest point-in-time the backfill has reached, if known
 * @param percent           0-100 estimate, if the integration can compute one
 */
public record BackfillSummary(@NonNull String state, @Nullable Instant completedThrough, @Nullable Integer percent) {}
