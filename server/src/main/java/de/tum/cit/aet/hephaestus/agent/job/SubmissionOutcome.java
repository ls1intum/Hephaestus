 ...
 *
 * <p>The reason is the same controlled one the ledger records, carried through to the caller rather than
 * flattened into an empty result — a wrong guessed reason is worse than a missing one.
 */
