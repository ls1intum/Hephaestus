...
import static de.tum.cit.aet.hephaestus.integration.github.common.GitHubGraphQlErrorUtils.isNotFoundError;
...
import de.tum.cit.aet.hephaestus.integration.github.pullrequestreviewcomment.dto.GitHubPullRequestReviewCommentEventDTO.GitHubReviewCommentDTO;
...
import de.tum.cit.aet.hephaestus.integration.scm.graphql.github.model.GHDiffSide;
...
import de.tum.cit.aet.hephaestus.integration.scm.graphql.github.model.GHPullRequestReviewThread;
 ...
 *
 * @see de.tum.cit.aet.hephaestus.integration.github.pullrequest.GitHubPullRequestSyncService
 */
            ...
            .orElseGet(() -> {
                ...
                if (threadDto.isResolved()) {
                    ...
                    if (resolvedByDto != null) {
                        de.tum.cit.aet.hephaestus.integration.scm.user.User resolvedBy = userProcessor.ensureExists(
                            resolvedByDto,
