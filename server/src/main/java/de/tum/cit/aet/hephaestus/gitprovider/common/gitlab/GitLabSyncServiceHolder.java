package de.tum.cit.aet.hephaestus.gitprovider.common.gitlab;

import de.tum.cit.aet.hephaestus.gitprovider.commit.gitlab.GitLabCommitBackfillService;
import de.tum.cit.aet.hephaestus.gitprovider.commit.gitlab.GitLabCommitMergeRequestLinker;
import de.tum.cit.aet.hephaestus.gitprovider.commit.gitlab.GitLabCommitSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.issue.gitlab.GitLabIssueSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.issuedependency.gitlab.GitLabIssueDependencySyncService;
import de.tum.cit.aet.hephaestus.gitprovider.issuetype.gitlab.GitLabIssueTypeSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.label.gitlab.GitLabLabelSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.milestone.gitlab.GitLabMilestoneSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.organization.gitlab.GitLabGroupMemberSyncService;
...
import de.tum.cit.aet.hephaestus.gitprovider.repository.collaborator.gitlab.GitLabCollaboratorSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.subissue.gitlab.GitLabSubIssueSyncService;
import de.tum.cit.aet.hephaestus.gitprovider.team.gitlab.GitLabTeamSyncService;
