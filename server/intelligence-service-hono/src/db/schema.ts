...
import { pgTable, varchar, timestamp, integer, boolean, bigint, foreignKey, text, smallint, uuid, jsonb, unique, primaryKey, index } from "drizzle-orm/pg-core"
...
export const team = pgTable("team", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "team_id_seq", startWith: 1, increment: 1, cache: 1 }),
	name: varchar({ length: 255 }),
...
export const workspace = pgTable("workspace", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "workspace_id_seq", startWith: 1, increment: 1, cache: 1 }),
...
export const repositoryToMonitor = pgTable("repository_to_monitor", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "repository_to_monitor_id_seq", startWith: 1, increment: 1, cache: 1 }),
...
export const badPracticeDetection = pgTable("bad_practice_detection", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "bad_practice_detection_id_seq", startWith: 1, increment: 1, cache: 1 }),
...
export const badPracticeFeedback = pgTable("bad_practice_feedback", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "bad_practice_feedback_id_seq", startWith: 1, increment: 1, cache: 1 }),
	explanation: text(),
	type: varchar({ length: 255 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const pullrequestbadpractice = pgTable("pullrequestbadpractice", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "pullrequestbadpractice_id_seq", startWith: 1, increment: 1, cache: 1 }),
	description: text(),
	title: varchar({ length: 255 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	pullrequestId: bigint("pullrequest_id", { mode: "number" }),
